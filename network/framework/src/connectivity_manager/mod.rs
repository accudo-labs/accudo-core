...
use accudo_num_variants::NumVariants;
use accudo_short_hex_str::AsShortHexStr;
use accudo_time_service::{TimeService, TimeServiceTrait};
use accudo_types::{account_address::AccountAddress, network_address::NetworkAddress, PeerId};
use futures::{
    channel::oneshot,
...
pub struct ConnectivityManager<TBackoff> {
    ...
    requests_rx: accudo_channels::Receiver<ConnectivityRequest>,
