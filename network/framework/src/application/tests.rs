...
use accudo_peer_monitoring_service_types::PeerMonitoringMetadata;
...
/// Returns an accudo channel for testing
...
fn create_network_sender_and_events(
    ...
    for network_id in network_ids {
        ...
        let (connection_outbound_sender, _connection_outbound_receiver) = create_accudo_channel();
