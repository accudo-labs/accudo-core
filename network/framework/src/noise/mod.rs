...
//! We use Noise to secure connections between peers in Accudo.
...
//!
//! ```
//! use accudo_network::noise::{AntiReplayTimestamps, HandshakeAuthMode, NoiseUpgrader};
//! use futures::{executor, future, io::{AsyncReadExt, AsyncWriteExt}};
//! use accudo_memsocket::MemorySocket;
//! use accudo_config::{config::{Peer, PeerRole}, network_id::{NetworkContext, NetworkId}};
//! use accudo_crypto::{x25519, ed25519, Uniform, PrivateKey, test_utils::TEST_SEED};
//! use accudo_infallible::RwLock;
//! use rand::{rngs::StdRng, SeedableRng};
//! use accudo_types::PeerId;
//! use std::{collections::{HashSet, HashMap}, io, sync::Arc};
//! use accudo_config::config::RoleType;
...
//! [crypto]: ../accudo_crypto/noise/index.html
