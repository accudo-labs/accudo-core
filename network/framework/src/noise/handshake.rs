...
pub enum HandshakeAuthMode {
    ...
    ///
    /// For example, in the Accudo validator network, validator peers will only
                ...
                match trusted_peer {
                    ...
                    None => {
                        ...
                        let derived_remote_peer_id =
                            accudo_types::account_address::from_identity_public_key(
                                remote_public_key,
                            );
...
mod test {
    ...
    use accudo_config::config::{Peer, PeerRole, RoleType};
    use accudo_crypto::{
