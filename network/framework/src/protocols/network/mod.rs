...
//! Convenience Network API for Accudo
...
/// Configuration needed for the client side of AccudoNet applications
#[derive(Clone)]
...
/// Configuration needed for the service side of AccudoNet applications
#[derive(Clone)]
pub struct NetworkServiceConfig {
    ...
    pub inbound_queue_config: accudo_channel::Config,
}
...
impl NetworkServiceConfig {
    pub fn new(
        direct_send_protocols_and_preferences: Vec<ProtocolId>,
        rpc_protocols_and_preferences: Vec<ProtocolId>,
        inbound_queue_config: accudo_channel::Config,
    ) -> Self {
        Self {
            direct_send_protocols_and_preferences,
            rpc_protocols_and_preferences,
...
/// Configuration needed for AccudoNet applications to register with the network
...
pub trait NewNetworkEvents {
    fn new(
        peer_mgr_notifs_rx: accudo_channel::Receiver<(PeerId, ProtocolId), ReceivedMessage>,
...
/// a thin wrapper on `accudo_channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>`,
