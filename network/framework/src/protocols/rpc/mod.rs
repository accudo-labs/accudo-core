...
//! Implementation of the unary RPC protocol as per [AccudoNet wire protocol v1].
//!
//! ## Design:
//!
...
//!
//! [AccudoNet wire protocol v1]: https://github.com/accudo-labs/accudo-core/blob/main/specifications/network/messaging-v1.md
...
impl InboundRpcs {
    ...
    pub fn handle_inbound_request(
        &mut self,
        peer_notifs_tx: &accudo_channel::Sender<(PeerId, ProtocolId), ReceivedMessage>,
