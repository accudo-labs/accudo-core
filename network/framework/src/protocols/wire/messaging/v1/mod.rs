...
//! This module defines the AccudoNet v1 message types, how they are
...
//!
//! The [AccudoNet Specification](https://github.com/accudo-labs/accudo-core/blob/main/documentation/specifications/network/messaging-v1.md)
