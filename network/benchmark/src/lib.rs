...
use accudo_metrics_core::{register_int_counter_vec, IntCounter, IntCounterVec};
use accudo_network::{
...
use accudo_types::{account_address::AccountAddress, PeerId};
use bytes::Bytes;
use futures::{
...
pub static PENDING_NETBENCH_NETWORK_EVENTS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_netbench_pending_network_events",
...
pub static ACCUDO_NETWORK_BENCHMARK_DIRECT_MESSAGES: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_network_benchmark_direct_messages",
...
pub static ACCUDO_NETWORK_BENCHMARK_DIRECT_BYTES: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_network_benchmark_direct_bytes",
...
pub static ACCUDO_NETWORK_BENCHMARK_DIRECT_MICROS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_network_benchmark_direct_micros",
...
pub static ACCUDO_NETWORK_BENCHMARK_RPC_MESSAGES: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_network_benchmark_rpc_messages",
...
pub static ACCUDO_NETWORK_BENCHMARK_RPC_BYTES: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_network_benchmark_rpc_bytes",
...
pub fn rpc_bytes(state_label: &'static str) -> IntCounter {
    ACCUDO_NETWORK_BENCHMARK_RPC_BYTES.with_label_values(&[state_label])
}

pub static ACCUDO_NETWORK_BENCHMARK_RPC_MICROS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_network_benchmark_rpc_micros",
...
pub fn rpc_micros(state_label: &'static str) -> IntCounter {
    ACCUDO_NETWORK_BENCHMARK_RPC_MICROS.with_label_values(&[state_label])
}
