...
use accudo_config::{config::PeerSet, network_id::NetworkContext};
use accudo_logger::info;
use accudo_time_service::{Interval, TimeService, TimeServiceTrait};
use accudo_types::{account_address::AccountAddress, on_chain_config::ValidatorSet};
...
impl RestStream {
    pub(crate) fn new(
        ...
        RestStream {
            network_context,
            rest_client: accudo_rest_client::Client::new(rest_url),
