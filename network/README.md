...
id: network
title: Network
custom_edit_url: https://github.com/accudo-labs/accudo-core/edit/main/network/README.md
---

## Overview

For more detailed info, see the [AccudoNet Specification](../documentation/specifications/network/README.md).

AccudoNet is the primary protocol for communication between any two nodes in the
Accudo ecosystem. It is specifically designed to facilitate the consensus, shared
mempool, and state sync protocols. AccudoNet tries to maintain at-most one connection
...
+ [`AccudoTransport`] &mdash; A secure, reliable transport. It uses [NoiseIK] over
TCP to negotiate an encrypted and authenticated connection between peers.
The AccudoNet version and any Accudo-specific application protocols are negotiated
afterward using the [AccudoNet Handshake Protocol].
...
## How is this module organized?
    ...
    └── src
        ...
        │   └── wire               # Protocol for AccudoNet handshakes and messaging
...
[`AccudoNet Handshake Protocol`]: ../specifications/network/handshake-v1.md
[`ValidatorSet`]: ../types/src/on_chain_config/validator_set.rs
[`AccudoTransport`]: ./src/transport/mod.rs
