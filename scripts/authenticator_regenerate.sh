...
(
  ...
  echo "See https://github.com/accudo-labs/accudo-core-private/tree/main/protos/README.md if you're having troubles"
  cd protos/
...
(
  ...
  cargo run -p generate-format -- --corpus accudo --record
...
(
  echo
  echo "Regenerating Accudo Node APIs (in `pwd`)"
  # Accudo Node API
...
echo " 1. Check out https://github.com/accudo-labs/accudo-core/blob/main/testsuite/generate-format/README.md"
