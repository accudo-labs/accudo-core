...
# so this should be larger than `LATEST_GAS_FEATURE_VERSION` in `accudo-move/accudo-gas/src/gas_meter.rs`.
...
def main(gas_per_ns):
    path = Path('accudo-move/accudo-gas-schedule/src/gas_schedule/accudo_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs batch verification in `accudo-move/accudo-gas-schedule/src/gas_schedule/accudo_framework.rs`.')
