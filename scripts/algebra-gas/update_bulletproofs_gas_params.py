...
def main(gas_per_ns):
    path = Path('accudo-move/accudo-gas/src/accudo_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs module in `accudo-move/accudo-gas/src/accudo_framework.rs`.')
