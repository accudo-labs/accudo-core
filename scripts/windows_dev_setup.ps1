# This script installs the necessary dependencies to build in Accudo.
...
function welcome_message {
    $message = "`nWelcome to Accudo!
    `nThis script will download and install the necessary dependencies for Accudo Core based on your selection:
      * Install Accudo build tools: t
...
function build_tools_message {
    ...
    `nThis script will download and install the following dependencies needed to build Accudo Core if not found on your system:
...
function update_versions {
  try {
    ...
    $url = "https://raw.githubusercontent.com/accudo-labs/accudo-core/main/scripts/dev_setup.sh"
