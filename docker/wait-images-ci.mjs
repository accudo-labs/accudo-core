...
// Try it out:
// GCP_DOCKER_ARTIFACT_REPO=us-docker.pkg.dev/accudo-registry/docker GIT_SHA=$(git fetch && git rev-parse origin/main) ./docker/wait-images-ci.mjs --wait-for-image-seconds=3600
import {
