---
id: docker_compose
title: Accudo Docker-Compose Configuration
custom_edit_url: https://github.com/accudo/accudo/edit/main/docker/compose/README.md
---
...
If you would like to clear the validator/blockchain data and start from scratch, either remove the docker volume `accudo-shared`,
or run `docker-compose run validator rm -rf '/opt/accudo/var/*'` from the **validator-testnet** directory.

To clear just the validator logs, run  `docker-compose run validator rm -rf '/opt/accudo/var/validator.log'`
