...
NODE_CONFIG_MOUNT_NAME: str = "accudo-config"
NODE_CONFIG_MOUNT_PATH: str = "/opt/accudo/etc"
GENESIS_ARTIFACTS_MOUNT_NAME: str = "genesis-config"
GENESIS_ARTIFACTS_MOUNT_PATH: str = "/opt/accudo/genesis"
NODE_IDENTITY_MOUNT_NAME: str = "accudo-secret"
NODE_IDENTITY_MOUNT_PATH: str = "/opt/accudo/identites"
...
DEFAULT_IMAGE: str = "accudolabs/validator:devnet@sha256:f0c62463b0e86acc9ad081c54be2d1823f143f780c73828b876caebc978c8947"
ACCUDO_DATA_NAME: str = "accudo-data"
ACCUDO_DATA_DIR: str = "/opt/accudo/data"
...
DEFAULT_TRANSACTION_EMITTER_IMAGE: str = "accudolabs/tools:devnet"
