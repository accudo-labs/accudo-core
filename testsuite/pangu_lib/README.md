...
Ever had to wait for the Accudo devnet/testnet releases to test a new feature? Or, create a PR to launch testnets through Forge? Well, these will be a thing of the past with Pangu.

Pangu is a modular, customizable, and next-gen Accudo testnet creation-management CLI tool written in Python. Pangu allows you to create, and manage testnets on demand, and blazingly fast 🚀🚀🚀 
...
1. **`-pangu-node-configs-path`**:
    ...
    - Default: The default node config in accudo-core/testsuite/pangu_lib/template_testnet_files
    - Example: **`-pangu-node-configs-path /path/to/node/configs.yaml`**
2. **`-layout-path`**:
    - The path to the layout file (yaml).
    - Default: The default layout in accudo-core/testsuite/pangu_lib/template_testnet_files
...
1. **`-accudo-cli-path`**:
    - The path to the Accudo CLI if it is not in your $PATH variable.
    - Default: **`accudo`**
    - Example: **`-accudo-cli-path /path/to/accudo`**
2. **`-name`**:
...
[Pangu config template](https://github.com/accudo-labs/accudo-core/blob/main/testsuite/pangu_lib/template_testnet_files/pangu_node_config.yaml)
...
- [**See the default config here**](https://github.com/accudo-labs/accudo-core/blob/main/testsuite/pangu_lib/template_testnet_files/pangu_node_config.yaml)
...
**1-** Have accudo-core installed locally, and navigate to the testsuite directory. 
...
**4-** Have a K8s environment set up. For testing purposes, I suggest you use KinD. [Here is a script that can be used to set up KinD.](https://github.com/accudo-labs/internal-ops/blob/main/docker/kind/start-kind.sh)

**5-** Use “pangu -h”, “pangu node -h”, and “pangu testnet -h” commands to get more info about the Pangu commands

## Codebase

Pangu lives in accudo-core/testsuite. Tips for navigating the codebase:

- [**accudo-core/testsuite/pangu.py**](https://github.com/accudo-labs/accudo-core/blob/main/testsuite/pangu.py)
    - This is the entry point to the Pangu CLI. Use poetry run python pangu.py to run.
- [**accudo-core/testsuite/test_framework**](https://github.com/accudo-labs/accudo-core/tree/main/testsuite/test_framework)
...
- [**accudo-core/testsuite/pangu_lib/node_commands**](https://github.com/accudo-labs/accudo-core/tree/main/testsuite/pangu_lib/node_commands)
...
- [a**ptos-core/testsuite/pangu_lib/testnet_commands**](https://github.com/accudo-labs/accudo-core/tree/main/testsuite/pangu_lib/testnet_commands)
    - Includes the commands for the pangu testnet {COMMAND} commands
    - Each command has its own .py file, which are then aggregated in the commands.py file to be exported to pangu.py
- [**accudo-core/testsuite/pangu_lib/tests**](https://github.com/accudo-labs/accudo-core/tree/main/testsuite/pangu_lib/tests)
    - Includes the unit tests
- [**accudo-core/testsuite/pangu-sdk**](https://github.com/accudo-labs/accudo-core/tree/main/testsuite/pangu-sdk)
