...
const GRPC_METHOD = "accudo.indexer.v1.RawData/GetTransactions";

// relative path from this directory to the proto files
const GRPC_IMPORT_PATHS = ["../../../crates/accudo-protos/proto"];
const GRPC_PROTOS = ["accudo/indexer/v1/raw_data.proto"];
...
// Inspiration from: https://github.com/accudo-labs/accudo-indexer-processors/blob/main/typescript/processors/example-write-set-change-processor/processor.ts
export default () => {
  if (__ITER == 0) {
