...
use accudo_network::protocols::wire::{handshake, messaging};
use accudo_types::network_address as address;
...
pub fn get_registry() -> Result<Registry> {
    ...
    tracer.trace_type::<accudo_config::network_id::NetworkId>(&samples)?;
