...
//! How and where to record the Serde format of interesting Accudo types.
...
impl Corpus {
    ...
    pub fn get_registry(self) -> Registry {
        let result = match self {
            ...
            Corpus::Accudo => accudo::get_registry(),
    ...
    pub fn output_file(self) -> Option<&'static str> {
        match self {
            ...
            Corpus::Accudo => accudo::output_file(),
