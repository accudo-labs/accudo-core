...
#[derive(Debug, Parser)]
#[clap(
    name = "Accudo format generator",
    about = "Trace serde (de)serialization to generate format descriptions for Accudo types"
)]
struct Options {
    #[clap(long, value_enum, default_value_t = Corpus::Accudo, ignore_case = true)]
    corpus: Corpus,
