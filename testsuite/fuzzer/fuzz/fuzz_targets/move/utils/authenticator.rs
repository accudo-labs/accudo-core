...
use accudo_types::keyless::{AnyKeylessPublicKey, EphemeralCertificate};
...
pub(crate) mod miscellaneous {
    use accudo_crypto::{ed25519::ed25519_keys::Ed25519PrivateKey, PrivateKey, Uniform};
    use accudo_types::{
    ...
    impl Default for SampleJwtPayload {
        fn default() -> Self {
            ...
            SampleJwtPayload {
                ...
                hd: "accudo.org".to_string(),
                email: "michael@accudo.org".to_string(),
                email_verified: true,
