...
# "https://storage.googleapis.com/accudo-core-corpora/move_accudovm_publish_seed_corpus.zip"
CORPUS_ZIPS=(
    "https://storage.googleapis.com/accudo-core-corpora/move_accudovm_publish_and_run_seed_corpus.zip"
    "https://storage.googleapis.com/accudo-core-corpora/move_accudovm_publish_and_run_transactional_seed_corpus.zip"
)
...
function build-oss-fuzz() {
    ...
    cp "$oss_fuzz_out/move_accudovm_publish_and_run_seed_corpus.zip" "$oss_fuzz_out/move_accudovm_publish_seed_corpus.zip"
    cp "$oss_fuzz_out/move_accudovm_publish_and_run_seed_corpus.zip" "$oss_fuzz_out/move_bytecode_verifier_compiled_modules_seed_corpus.zip"
}
