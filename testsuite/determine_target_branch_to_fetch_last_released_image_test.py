...
class TestDetermineTargetBranch(unittest.TestCase):
    ...
    def test_determine_target_branch_to_fetch_last_released_image_main(self, mock_git):
        ...
        mock_git.get_remote_branches_matching_pattern.return_value = [
            "accudo-release-v1.19",
            "accudo-release-v1.18",
        ]
        mock_git.get_branch_creation_time.side_effect = (
            lambda branch: datetime(2024, 9, 1)
            if branch == "accudo-release-v1.19"
            else datetime(2024, 8, 1)
        )

        result = determine_target_branch("main")

        self.assertEqual(result, "accudo-release-v1.19")

    @patch("determine_target_branch_to_fetch_last_released_image.git")
    def test_determine_target_branch_to_fetch_last_released_image_accudo_release(
        self, mock_git
    ):
        """Test case for determining target branch when the base branch is an accudo-release-vX.Y branch."""
        mock_git.get_remote_branches_matching_pattern.return_value = [
            "accudo-release-v1.20",
            "accudo-release-v1.19",
            "accudo-release-v1.18",
            "accudo-release-v1.17",
        ]

        # Mock the branch creation times
        mock_git.get_branch_creation_time.side_effect = lambda branch: {
            "accudo-release-v1.20": "2023-09-20 12:00:00 +0000",
            "accudo-release-v1.19": "2023-06-15 12:00:00 +0000",
            "accudo-release-v1.18": "2023-03-10 12:00:00 +0000",
            "accudo-release-v1.17": "2023-01-05 12:00:00 +0000",
        }[branch]

        result = determine_target_branch("accudo-release-v1.19")
        self.assertEqual(result, "accudo-release-v1.18")

        mock_git.get_remote_branches_matching_pattern.return_value = [
            "accudo-release-v0.1",
            "accudo-release-v0.11",
        ]
        mock_git.get_branch_creation_time.side_effect = lambda branch: {
            "accudo-release-v1.18": "2023-03-10 12:00:00 +0000",
            "accudo-release-v1.0": "2023-01-01 12:00:00 +0000",
            "accudo-release-v0.11": "2022-07-01 12:00:00 +0000",
            "accudo-release-v0.1": "2022-06-01 12:00:00 +0000",
        }[branch]

        result = determine_target_branch("accudo-release-v1.0")
        self.assertEqual(result, "accudo-release-v0.11")
    ...
    def test_get_latest_branch_for_previous_major(self, mock_git):
        ...
        self.assertEqual(result, "accudo-release-v0.2")
    ...
    def test_get_all_release_branches(self, mock_git):
        ...
        self.assertEqual(
            result,
            ["accudo-release-v1.17", "accudo-release-v1.18", "accudo-release-v1.19"],
        )
    ...
    def test_get_all_release_branches_with_times(self, mock_git):
        ...
        expected = [
            ("accudo-release-v1.18", datetime(2024, 8, 1)),
            ("accudo-release-v1.19", datetime(2024, 9, 1)),
        ]
