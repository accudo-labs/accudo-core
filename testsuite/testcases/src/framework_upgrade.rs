...
use accudo_release_builder::ReleaseConfig;
...
const RELEASE_YAML_PATH: &str = "accudo-move/accudo-release-builder/data";
...
impl NetworkTest for FrameworkUpgrade {
    async fn run<'a>(&self, ctx: NetworkContextSynchronizer<'a>) -> Result<()> {
        ...
        let network_info = accudo_release_builder::validate::NetworkConfig {
            endpoint: ctx
                .swarm
                .read()
                .await
        ...
        let release_config = accudo_release_builder::current_release_config();

        accudo_release_builder::validate::validate_config(
