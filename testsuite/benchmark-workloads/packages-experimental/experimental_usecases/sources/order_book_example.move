module 0xABCD::order_book_example {
    ...
    use accudo_experimental::order_book_types::{OrderIdType, good_till_cancelled, OrderMatch};
    use accudo_experimental::order_book;
    use accudo_experimental::order_book::OrderBook;
    ...
    public entry fun place_order(market_id: u32, sender: address, order_id: u64, bid_price: u64, volume: u64, is_bid: bool) acquires Dex {
        ...
        place_order_and_get_matches(
            order_book,
            sender, // account
            accudo_experimental::order_book_types::new_order_id_type(order_id as u128),
            bid_price,
            volume,
            volume,
            is_bid,
    ...
    public entry fun cancel_order(market_id: u32, order_id: u64) acquires Dex {
        let order_book = borrow_order_book_mut(market_id);
        order_book.cancel_order(@publisher_address, accudo_experimental::order_book_types::new_order_id_type(order_id as u128));
    }
