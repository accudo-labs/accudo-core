...
# Paths are relative to the root of the accudo-core repository.
PACKAGES = [
    "testsuite/benchmark-workloads/packages",
    "accudo-move/move-examples/token_objects/ambassador",
    "accudo-move/move-examples/aggregator_examples",
    "accudo-move/move-examples/bcs-stream"
]
