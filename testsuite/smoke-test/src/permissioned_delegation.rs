...
async fn test_permissioned_delegation() {
    ...
    use accudo_framework::permissioned_delegation;
    use accudo_framework::primary_fungible_store;
    use accudo_framework::transaction_validation;
    fun main(sender: &signer) {{
        coin::migrate_to_fungible_store<accudo_framework::accudo_coin::AccudoCoin>(sender);
