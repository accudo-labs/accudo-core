...
use accudo_forge::{Node, Swarm, SwarmExt};
use accudo_logger::{debug, info};
use accudo_types::{dkg::DKGState, on_chain_config::OnChainRandomnessConfig};
...
async fn enable_feature_2() {
    ...
    let client = accudo_rest_client::Client::new(client_endpoint.clone());
