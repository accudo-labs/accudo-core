...
use crate::{accudo::move_test_helpers, smoke_test_environment::new_local_swarm_with_accudo};
...
async fn test_package_publish() {
    ...
    let base_path_v2 = base_dir.join("src/accudo/package_publish_modules_v2/");
    let base_path_v3 = base_dir.join("src/accudo/package_publish_modules_v3/");
