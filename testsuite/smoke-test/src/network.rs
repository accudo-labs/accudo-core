...
use accudo_crypto::{encoding_type::EncodingType, x25519, x25519::PrivateKey};
use accudo_forge::{FullNode, Node, NodeExt, Swarm};
...
async fn test_rest_discovery() {
    let mut swarm = SwarmBuilder::new_local(1).with_accudo().build().await;
...
// Currently this test seems flaky: https://github.com/accudo-labs/accudo-core/issues/670
#[ignore]
#[tokio::test]
