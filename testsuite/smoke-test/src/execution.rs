...
use crate::{
    accudo_cli::validator::generate_blob, smoke_test_environment::SwarmBuilder,
    utils::get_current_version,
};
use accudo::test::CliTestFramework;
use accudo_forge::{NodeExt, Swarm, SwarmExt};
...
async fn fallback_test() {
    ...
    client
        .set_failpoint(
            "accudo_vm::vm_wrapper::execute_transaction".to_string(),
