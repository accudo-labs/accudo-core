...
fn indexer_status_url(chain_id: ChainId) -> &'static str {
    if chain_id.is_mainnet() {
        "https://indexer.mainnet.accudo.org/api/rest/get_latest_processor_status"
    } else if chain_id.is_testnet() {
        "https://indexer-testnet.staging.gcp.accudodev.com/api/rest/get_latest_processor_status"
    } else {
        "https://indexer-devnet.staging.gcp.accudodev.com/api/rest/get_latest_processor_status"
    }
}
