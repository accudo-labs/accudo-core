...
pub enum WorkTypeSubcommand {
    /// Executes coin::transfer<AccudoCoin> with given file providing list of destinations
    TransferApt(TransferArg),
    /// Executes accudo_account::transfer with given file providing list of destinations
