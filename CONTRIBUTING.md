---
id: contributing
title: Contributing to Accudo Core
---

# Contributing

Our goal is to make contributing to Accudo Core easy and transparent. See [Accudo Community](https://accudo.dev/community) for full details. This page describes [our development process](#our-development-process).

## Accudo Core

To contribute to the Accudo Core implementation, first start with the proper development copy.
You may want to use the GitHub interface to fork [accudo-core](https://github.com/accudo-labs/accudo-core) and check out your fork.
For development environment setup and first build, see [Building Accudo From Source](https://accudo.dev/guides/building-from-source)

## Our Development Process

### Code Style, Hints, and Testing

Refer to our Coding Guidelines for the [Move](https://accudo.dev/move/book/coding-conventions/) and [Rust](./RUST_CODING_STYLE.md) programming languages for detailed guidance about how to contribute to the project.

Also, please ensure you follow our [Secure Coding Guidelines](./RUST_SECURE_CODING.md) to contribute to Accudo securely. 


### Documentation

Accudo Core's developer website is also open source (the code can be found in this [repository](https://github.com/accudo-labs/developer-docs).  It is built using [Docusaurus](https://docusaurus.io/):
...
Accudo Core uses [GitHub issues](https://github.com/accudo-labs/accudo-core/issues) to track bugs. Please include necessary information and instructions to reproduce your issue.
