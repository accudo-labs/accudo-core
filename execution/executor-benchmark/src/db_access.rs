...
impl CommonStructTags {
    pub fn new() -> Self {
        Self {
            ...
            apt_coin_store: CoinStoreResource::<AccudoCoinType>::struct_tag(),
            ...
            apt_coin_type_name: "0x1::accudo_coin::AccudoCoin".to_string(),
            apt_coin_info_resource: StateKey::resource_typed::<CoinInfoResource<AccudoCoinType>>(
                &AccudoCoinType::coin_info_address(),
            )
            .unwrap(),
        }
    }
...
impl DbAccessUtil {
    ...
    pub fn new_state_key_accudo_coin(&self, address: &AccountAddress) -> StateKey {
    ...
    pub fn get_apt_coin_store(
        ...
        state_view: &impl StateView,
    ) -> Result<Option<CoinStoreResource<AccudoCoinType>>> {
    ...
    pub fn new_apt_coin_store(
        balance: u64,
        address: AccountAddress,
    ) -> CoinStoreResource<AccudoCoinType> {
        CoinStoreResource::<AccudoCoinType>::new(
            balance,
            false,
            EventHandle::new(EventKey::new(1, address), 0),
            EventHandle::new(EventKey::new(2, address), 0),
