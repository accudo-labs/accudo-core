...
use accudo_vm::{AccudoVM, VMBlockExecutor};
...
pub struct AccudoVMParallelUncoordinatedBlockExecutor;

impl VMBlockExecutor for AccudoVMParallelUncoordinatedBlockExecutor {
    fn new() -> Self {
        Self
    }
