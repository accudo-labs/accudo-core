...
- Transaction verification now requires Dilithium-sidecar signatures for any
  classical authenticator; requests missing PQ material are rejected by the API,
  mempool, and consensus pipelines.
