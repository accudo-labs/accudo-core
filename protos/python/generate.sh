...
python -m grpc_tools.protoc \
    ...
    $PROTO_DIR/accudo/indexer/v1/raw_data.proto \
    $PROTO_DIR/accudo/internal/fullnode/v1/fullnode_data.proto \
    $PROTO_DIR/accudo/transaction/v1/transaction.proto \
    $PROTO_DIR/accudo/util/timestamp/timestamp.proto
