...
export const RawDataService = {
  ...
  getTransactions: {
    path: "/accudo.indexer.v1.RawData/GetTransactions",
    requestStream: false,
    responseStream: true,
...
export const RawDataClient = makeGenericClientConstructor(RawDataService, "accudo.indexer.v1.RawData") as unknown as {
