...
*/
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.indexer.v1.RawData/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("accudo.indexer.v1.RawData", "GetTransactions"));
...
*/
    ...
    impl<T: RawData> tonic::server::NamedService for RawDataServer<T> {
        const NAME: &'static str = "accudo.indexer.v1.RawData";
    }
}
/// Generated client implementations.
pub mod grpc_manager_client {
    ...
    ///
    #[derive(Debug, Clone)]
    pub struct GrpcManagerClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl GrpcManagerClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> GrpcManagerClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.indexer.v1.GrpcManager/Heartbeat",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("accudo.indexer.v1.GrpcManager", "Heartbeat"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.indexer.v1.GrpcManager/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("accudo.indexer.v1.GrpcManager", "GetTransactions"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_data_service_for_request(
            &mut self,
            request: impl tonic::IntoRequest<super::GetDataServiceForRequestRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetDataServiceForRequestResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.indexer.v1.GrpcManager/GetDataServiceForRequest",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "accudo.indexer.v1.GrpcManager",
...
pub mod grpc_manager_server {
    ...
    pub trait GrpcManager: Send + Sync + 'static {
        ...
        async fn get_data_service_for_request(
            &self,
            request: tonic::Request<super::GetDataServiceForRequestRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetDataServiceForRequestResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/accudo.indexer.v1.GrpcManager/Heartbeat" => {
                    ...
                    for HeartbeatSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as GrpcManager>::heartbeat(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/accudo.indexer.v1.GrpcManager/GetTransactions" => {
                    ...
                    for GetTransactionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as GrpcManager>::get_transactions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/accudo.indexer.v1.GrpcManager/GetDataServiceForRequest" => {
                    ...
                    impl<
                        T: GrpcManager,
                    > tonic::server::UnaryService<super::GetDataServiceForRequestRequest>
                    for GetDataServiceForRequestSvc<T> {
                        type Response = super::GetDataServiceForRequestResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::GetDataServiceForRequestRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as GrpcManager>::get_data_service_for_request(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetDataServiceForRequestSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: GrpcManager> tonic::server::NamedService for GrpcManagerServer<T> {
        const NAME: &'static str = "accudo.indexer.v1.GrpcManager";
    }
}
/// Generated client implementations.
pub mod data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn ping(
            &mut self,
            request: impl tonic::IntoRequest<super::PingDataServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PingDataServiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.indexer.v1.DataService/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("accudo.indexer.v1.DataService", "Ping"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_transactions(
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.indexer.v1.DataService/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("accudo.indexer.v1.DataService", "GetTransactions"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
    }
...
pub mod data_service_server {
    ...
    pub trait DataService: Send + Sync + 'static {
        ...
        async fn ping(
            &self,
            request: tonic::Request<super::PingDataServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PingDataServiceResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/accudo.indexer.v1.DataService/Ping" => {
                    ...
                    impl<
                        T: DataService,
                    > tonic::server::UnaryService<super::PingDataServiceRequest>
                    for PingSvc<T> {
                        type Response = super::PingDataServiceResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataService>::ping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/accudo.indexer.v1.DataService/GetTransactions" => {
                    ...
                    > for GetTransactionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataService>::get_transactions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: DataService> tonic::server::NamedService for DataServiceServer<T> {
        const NAME: &'static str = "accudo.indexer.v1.DataService";
    }
}
