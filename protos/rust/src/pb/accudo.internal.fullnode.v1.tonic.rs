        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.internal.fullnode.v1.FullnodeData/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("accudo.internal.fullnode.v1.FullnodeData", "Ping"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/accudo.internal.fullnode.v1.FullnodeData/GetTransactionsFromNode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "accudo.internal.fullnode.v1.FullnodeData",
...
pub mod fullnode_data_server {
            ...
            match req.uri().path() {
                ...
                "/accudo.internal.fullnode.v1.FullnodeData/GetTransactionsFromNode" => {
                    ...
                    > for GetTransactionsFromNodeSvc<T> {
                        type Response = super::TransactionsFromNodeResponse;
    ...
    impl<T: FullnodeData> tonic::server::NamedService for FullnodeDataServer<T> {
        const NAME: &'static str = "accudo.internal.fullnode.v1.FullnodeData";
    }
}
