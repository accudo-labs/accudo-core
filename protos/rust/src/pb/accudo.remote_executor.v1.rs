...
/// Encoded file descriptor set for the `accudo.remote_executor.v1` package
...
include!("accudo.remote_executor.v1.serde.rs");
include!("accudo.remote_executor.v1.tonic.rs");
