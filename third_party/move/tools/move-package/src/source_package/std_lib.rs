...
impl StdLib {
    ...
    const STD_GIT_URL: &'static str = "https://github.com/accudo-labs/accudo-framework.git";
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            StdLib::AccudoToken => "AccudoToken",
            StdLib::AccudoTokenObjects => "AccudoTokenObjects",
            StdLib::AccudoFramework => "AccudoFramework",
            StdLib::AccudoStdlib => "AccudoStdlib",
    ...
    pub fn from_package_name(package_name: Symbol) -> Option<StdLib> {
        match package_name.as_str() {
            "AccudoToken" => Some(StdLib::AccudoToken),
            "AccudoTokenObjects" => Some(StdLib::AccudoTokenObjects),
            "AccudoFramework" => Some(StdLib::AccudoFramework),
            "AccudoStdlib" => Some(StdLib::AccudoStdlib),
    ...
    fn sub_dir(&self) -> &'static str {
        match self {
            StdLib::AccudoToken => "accudo-token",
            StdLib::AccudoTokenObjects => "accudo-token-objects",
            StdLib::AccudoFramework => "accudo-framework",
            StdLib::AccudoStdlib => "accudo-stdlib",
