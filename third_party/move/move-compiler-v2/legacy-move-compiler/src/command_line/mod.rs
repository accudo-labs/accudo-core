...
pub const WARN_OF_DEPRECATION_USE_IN_ACCUDO_LIBS: &str = "WARN_OF_DEPRECATION_USE_IN_ACCUDO_LIBS";
pub const WARN_OF_DEPRECATION_USE_IN_ACCUDO_LIBS_FLAG: &str = "Wdeprecation-accudo";
