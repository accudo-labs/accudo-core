...
use legacy_move_compiler::{
    ...
    shared::{
        ...
        warn_of_deprecation_use_in_accudo_libs_env_var,
    },
};
...
pub struct Options {
    ...
    #[clap(hide(true), long = cli::WARN_OF_DEPRECATION_USE_IN_ACCUDO_LIBS_FLAG,
           default_value=bool_to_str(warn_of_deprecation_use_in_accudo_libs_env_var()))]
    pub warn_of_deprecation_use_in_accudo_libs: bool,
...
impl Options {
    ...
    pub fn set_warn_of_deprecation_use_in_accudo_libs(self, value: bool) -> Self {
        Self {
            warn_of_deprecation_use_in_accudo_libs: value,
            ..self
        }
    }
