...
static CONFLICT_ERROR_MSG: &str = "cannot appear in both arithmetic and bitwise operation, please refer to https://accudo.dev/en/build/smart-contracts/prover/spec-lang#bitwise-operators for more information";
