...
pub fn benchmark(args: &[String]) {
    let cmd_line_parser = Command::new("benchmark")
        ...
        .arg(
            Arg::new("accudo-natives")
                .short('a')
                .long("accudo")
                .num_args(0)
                .action(Set)
                .help("whether the accudo-natives should be included."),
        )
        .arg(
    ...
    let use_accudo_natives = matches.contains_id("accudo-natives");
