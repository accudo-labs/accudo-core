...
6. Create a git tag `git tag accudo-sdk-v0.0.X HEAD` and push that tag to the accudo-labs/accudo-core repository.

Here is the set of currently published packages that make up the accudo-sdk:
* move-core-types
* accudo-crypto-derive
* accudo-crypto
* accudo-types
* accudo-json-rpc-types
* accudo-client
* accudo-sdk
