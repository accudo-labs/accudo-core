...
use accudo_logger::{
    accudo_logger::FileWriter, info, telemetry_log_writer::TelemetryLog, LoggerFilterUpdater,
};
...
pub fn create_logger(
    ...
    let mut logger_builder = accudo_logger::Logger::builder();
...
fn log_config_and_build_information(node_config: &NodeConfig) {
    ...
    // with the features defined in the accudo-node Cargo.toml file.
