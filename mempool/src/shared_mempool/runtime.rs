...
use accudo_config::config::{NodeConfig, NodeType};
...
use accudo_types::on_chain_config::OnChainConfigProvider;
use accudo_vm_validator::vm_validator::{PooledVMValidator, TransactionValidation};
    ...
    ConfigProvider: OnChainConfigProvider,
{
    ...
    if accudo_logger::enabled!(Level::Trace) {
