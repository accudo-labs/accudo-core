...
use accudo_mempool_notifications::CommittedTransaction;
use accudo_metrics_core::HistogramTimer;
use accudo_network::application::interface::NetworkClientInterface;
use accudo_storage_interface::state_store::state_view::db_state_view::LatestDbStateCheckpointView;
use accudo_types::{
        ...
        QuorumStoreRequest::GetBatchRequest(
            ...
            let txns = {
...

                {
                    ...
                    let curr_time = accudo_infallible::duration_since_epoch();
