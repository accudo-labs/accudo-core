...
pub use accudo_gas_schedule::LATEST_GAS_FEATURE_VERSION;
...
/// Returns [TypeBuilder] used by the Accudo blockchain in production.
pub fn accudo_prod_ty_builder(
    gas_feature_version: u64,
    gas_params: &AccudoGasParameters,
) -> TypeBuilder {
...
pub fn accudo_default_ty_builder() -> TypeBuilder {
    TypeBuilder::with_limits(128, 20)
}

/// Returns [DeserializerConfig] used by the Accudo blockchain in production.
pub fn accudo_prod_deserializer_config(features: &Features) -> DeserializerConfig {
...
/// Returns [VMConfig] used by the Accudo blockchain in production, based on the set of feature
/// flags.
pub fn accudo_prod_vm_config(
    gas_feature_version: u64,
    features: &Features,
    ...
    let deserializer_config = accudo_prod_deserializer_config(features);
    let verifier_config = accudo_prod_verifier_config(gas_feature_version, features);
