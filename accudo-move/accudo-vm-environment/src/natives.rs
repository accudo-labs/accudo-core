...
/// Builds and returns all Accudo native functions.
pub fn accudo_natives_with_builder(
    ...
    accudo_move_stdlib::natives::all_natives(CORE_CODE_ADDRESS, builder)
        .into_iter()
        ...
        .chain(accudo_framework::natives::all_natives(
            CORE_CODE_ADDRESS,
            builder,
            inject_create_signer_for_gov_sim,
        ))
        .chain(accudo_table_natives::table_natives(
            CORE_CODE_ADDRESS,
            builder,
        ))
        .collect()
