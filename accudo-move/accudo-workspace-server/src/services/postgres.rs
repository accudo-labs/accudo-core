...
pub fn get_postgres_connection_string_within_docker_network(instance_id: Uuid) -> String {
    format!(
        "postgres://{}@accudo-workspace-{}-postgres:{}/{}",
...
fn create_container_options_and_config(
    ...
    let options = CreateContainerOptions {
        name: format!("accudo-workspace-{}-postgres", instance_id),
        ..Default::default()
    };
...
pub fn start_postgres(
    ...
    let volume_name = format!("accudo-workspace-{}-postgres", instance_id);
    ...
    let fut_postgres_finish = async move {
        ...
        let _wait = docker
            .wait_container(
                &format!("accudo-workspace-{}-postgres", instance_id),
