...
use accudo_types::{
    executable::ModulePath, vm::modules::AccudoModuleExtension, write_set::TransactionWrite,
};
...
pub struct MVHashMap<K, T, V: TransactionWrite, I: Clone> {
    ...
    module_cache:
        SyncModuleCache<ModuleId, CompiledModule, Module, AccudoModuleExtension, Option<TxnIndex>>,
