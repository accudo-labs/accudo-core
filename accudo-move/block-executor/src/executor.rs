...
use crate::{
    ...
    code_cache_global_manager::AccudoModuleCacheManagerGuard,
    counters::{
...
use accudo_vm_logging::{alert, init_speculative_logs, prelude::*};
use accudo_vm_types::{change_set::randomly_check_layout_matches, resolver::ResourceGroupSize};
use bytes::Bytes;
    ...
    A: AuxiliaryInfoTrait,
{
    ...
    fn process_execution_result<'a>(
        ...
        read_set: &mut CapturedReads<T, ModuleId, CompiledModule, Module, AccudoModuleExtension>,
        txn_idx: TxnIndex,
    ...
    pub(crate) fn execute_transactions_parallel_v2(
        ...
        base_view: &S,
        transaction_slice_metadata: &TransactionSliceMetadata,
        module_cache_manager_guard: &mut AccudoModuleCacheManagerGuard,
