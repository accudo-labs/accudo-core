...
//! A model to test properties of common Accudo transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common Accudo
...
pub fn txn_one_account_result(
    ...
    // The transactions set the gas cost to 1 microaccudo.
