---
id: accudo-gas-calibration
title: Accudo Automated Gas Calibration
---

## Accudo Automated Gas Calibration

The Accudo Automated Gas Calibration is a tool that lets anyone write Move Samples (or also Move IR) to calibrate the gas parameters for Native Functions (and also Move bytecode instructions). 
...
mkdir MY-PROJECT
cd MY-PROJECT
cargo run -p accudo -- move init --name MY-PROJECT
```
...
Usage: accudo-gas-calibration [OPTIONS]
