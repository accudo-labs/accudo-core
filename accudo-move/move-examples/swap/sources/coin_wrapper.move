...
module swap::coin_wrapper {
    ...
    use accudo_framework::fungible_asset::{Self, BurnRef, FungibleAsset, Metadata, MintRef};
    ...
    /// CoinStore<CoinType> resource. See coin.move in the Accudo Framework for more details.
    struct WrapperAccount has key {
        ...
        // Map from an original coin type (represented as strings such as "0x1::accudo_coin::AccudoCoin") to the
    ...
    /// The return value is a String such as "0x1::accudo_coin::AccudoCoin" for an original coin or "0x12345" for a native
    /// fungible asset.
    ...
    public(friend) fun wrap<CoinType>(coins: Coin<CoinType>): FungibleAsset acquires WrapperAccount {
        ...
        accudo_account::deposit_coins(wrapper_address(), coins);
