...
module swap::router {
    ...
    use accudo_framework::fungible_asset::{Self, FungibleAsset, Metadata};
    ...
    public entry fun swap_asset_for_coin_entry<ToCoin>(
        ...
        accudo_account::deposit_coins(recipient, out);
    }
    ...
    public entry fun remove_liquidity_coin_entry<CoinType>(
        ...
        accudo_account::deposit_coins<CoinType>(recipient, amount_1);
        primary_fungible_store::deposit(recipient, amount_2);
    }
    ...
    public entry fun remove_liquidity_both_coins_entry<CoinType1, CoinType2>(
        ...
        accudo_account::deposit_coins<CoinType1>(recipient, amount_1);
        accudo_account::deposit_coins<CoinType2>(recipient, amount_2);
    }
