...
module example_addr::managed_fungible_asset {
    use accudo_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    use accudo_framework::object::{Self, Object, ConstructorRef};
    ...
    #[test_only]
    use accudo_framework::object::object_from_constructor_ref;
    #[test_only]
    use std::string::utf8;
    use std::vector;
