...
module example_addr::managed_fungible_token {
    ...
    use std::option;
    use accudo_token_objects::token::{create_named_token, create_token_seed};
    use accudo_token_objects::collection::create_fixed_collection;
    ...
    fun init_module(admin: &signer) {
        ...
        create_fixed_collection(
            ...
            collection_name,
            option::none(),
            utf8(b"http://accudo.org/collection"),
        );
