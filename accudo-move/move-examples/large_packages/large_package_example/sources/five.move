...
///
/// # Integrate with the Accudo Blockchain
///
/// If you provide blockchain services to your customers and wish to add the Accudo blockchain to your platform, then this guide is for you. This system integrators guide will walk you through all you need to integrate the Accudo blockchain into your platform.
///
/// ## Overview
///
/// This document will guide you through the following tasks to integrate with Accudo:
...
/// ### Choose a network
///
/// There are four well-supported networks for integrating with the Accudo blockchain:
///
...
/// 1. [Devnet](https://fullnode.devnet.accudo.org/v1/spec#/) -- a shared resource for the community, data resets weekly, weekly update from accudo-core main branch.
/// 1. [Testnet](https://fullnode.testnet.accudo.org/v1/spec#/) -- a shared resource for the community, data will be preserved, network configuration will mimic Mainnet.
/// 1. [Mainnet](https://fullnode.mainnet.accudo.org/v1/spec#/) -- a production network with real assets.
///
/// See [Accudo Blockchain Networks](../nodes/networks.md) for full details on each environment.
///
/// ### Run a localnet
///
/// There are two options for running a localnet:
/// * Directly [run a localnet](../nodes/local-testnet/run-a-local-testnet.md) using either the [Accudo-core source code](../nodes/local-testnet/run-a-local-testnet.md#using-the-accudo-core-source-code) or a [Docker image](../nodes/local-testnet/run-a-local-testnet.md#using-docker). These paths are useful for testing changes to the Accudo-core codebase or framework, or for building services on top of the Accudo blockchain, respectively.
/// * [Install the Accudo CLI](../tools/install-cli/index.md) and 2) start a [local node with a faucet](../nodes/local-testnet/using-cli-to-run-a-local-testnet.md#starting-a-local-testnet-with-a-faucet). This path is useful for developing on the Accudo blockchain, debugging Move contracts, and testing node operations.
///
/// Either of these methods will expose a [REST API service](../integration/fullnode-rest-api.md) at `http://127.0.0.1:8080` and a Faucet API service at `http://127.0.0.1:8000` for option 1 run a localnet or `http://127.0.0.1:8081` for option 2 install the Accudo CLI. The applications will output the location of the services.
///
...
///     <ul>
///       <li>REST API: <a href="https://fullnode.devnet.accudo.org/v1">https://fullnode.devnet.accudo.org/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.devnet.accudo.org/v1/spec#/">https://fullnode.devnet.accudo.org/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://api.devnet.accudo.org/v1/graphql">https://api.devnet.accudo.org/v1/graphql</a></li>
///       <li>Faucet API: <a href="https://faucet.devnet.accudo.org">https://faucet.devnet.accudo.org</a></li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://api.devnet.accudo.org/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
///   <TabItem value="testnet" label="Testnet">
///     <ul>
///       <li>REST API: <a href="https://fullnode.testnet.accudo.org/v1">https://fullnode.testnet.accudo.org/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.testnet.accudo.org/v1/spec#/">https://fullnode.testnet.accudo.org/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://api.testnet.accudo.org/v1/graphql">https://api.testnet.accudo.org/v1/graphql</a></li>
///       <li>Faucet API: <a href="https://faucet.testnet.accudo.org">https://faucet.testnet.accudo.org</a></li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://api.testnet.accudo.org/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
///   <TabItem value="mainnet" label="Mainnet">
///     <ul>
///       <li>REST API: <a href="https://fullnode.mainnet.accudo.org/v1">https://fullnode.mainnet.accudo.org/v1</a></li>
///       <li>REST API Spec: <a href="https://fullnode.mainnet.accudo.org/v1/spec#/">https://fullnode.mainnet.accudo.org/v1/spec#/</a></li>
///       <li>Indexer API: <a href="https://api.mainnet.accudo.org/v1/graphql">https://api.mainnet.accudo.org/v1/graphql</a></li>
///       <li>Faucet: N/A</li>
///       <li><a href="https://cloud.hasura.io/public/graphiql?endpoint=https://api.mainnet.accudo.org/v1/graphql">Indexer GraphQL</a></li>
///     </ul>
///   </TabItem>
/// </Tabs>
///
/// ### SDKs and tools
///
/// Accudo currently provides three SDKs:
/// 1. [Typescript](../sdks/ts-sdk/index.md)
/// 2. [Python](../sdks/python-sdk.md)
/// 3. [Rust](../sdks/rust-sdk.md)
///
/// Almost all developers will benefit from exploring the CLI. [Using the CLI](../tools/accudo-cli-tool/use-accudo-cli.md) demonstrates how the CLI can be used to which includes creating accounts, transferring coins, and publishing modules.
///
/// ## Accounts on Accudo
///
///
/// At creation, an [Accudo account](https://github.com/accudo-labs/accudo-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/accudo-move/framework/accudo-framework/sources/account.move#L23) contains:
/// * A [resource containing Accudo Coin](https://github.com/accudo-labs/accudo-core/blob/60751b5ed44984178c7163933da3d1b18ad80388/accudo-move/framework/accudo-framework/sources/coin.move#L50) and deposit and withdrawal of coins from that resource.
...
///
/// Read more about [Accounts](../concepts/accounts.md) and [set one up](../tools/accudo-cli-tool/use-accudo-cli#initialize-local-configuration-and-create-an-account).
///
/// ## Transactions
///
///
...
///
/// Accudo supports two methods for constructing transactions:
///
/// - Using the Accudo client libraries to generate native BCS transactions.
...
/// - A script (payload)
///
/// Both [Python](https://github.com/accudo-labs/accudo-core/blob/3973311dac6bb9348bfc81cf983c2a1be11f1b48/ecosystem/python/sdk/accudo_sdk/client.py#L256) and [TypeScript](https://github.com/accudo-labs/accudo-core/blob/3973311dac6bb9348bfc81cf983c2a1be11f1b48/ecosystem/typescript/sdk/src/accudo_client.test.ts#L93) support the generation of transactions that target entry points. This guide points out many of those entry points, such as `accudo_account::transfer` and `accudo_account::create_account`.
///
/// Most basic operations on the Accudo blockchain should be available via entry point calls. While one could submit multiple transactions calling entry points in series, such operations benefit from being called atomically from a single transaction. A script payload transaction can call any public (entry) function defined within any module. Here's an example [Move script](https://github.com/accudo-labs/accudo-core/tree/main/accudo-move/move-examples/scripts/two_by_two_transfer) that uses a MultiAgent transaction to extract funds from two accounts and deposit them into two other accounts. This is a [Python example](https://github.com/accudo-labs/accudo-core/blob/main/ecosystem/python/sdk/examples/transfer-two-by-two.py) that uses the bytecode generated by compiling that script. Currently there is limited support for script payloads in TypeScript.
///
...
///
/// To facilitate evaluation of transactions as well as gas estimation, Accudo supports a simulation API that does not require and should not contain valid signatures on transactions.
///
///
/// Both the [Typescript SDK](https://github.com/accudo-labs/accudo-core/blob/9b85d41ed8ef4a61a9cd64f9de511654fcc02024/ecosystem/typescript/sdk/src/accudo_client.ts#L413) and [Python SDK](https://github.com/accudo-labs/accudo-core/blob/main/ecosystem/python/sdk/examples/simulate-transfer-coin.py) support the simulation API. Note the output and gas used may change based upon the state of the account. For gas estimations, we recommend that the maximum gas amount be larger than the amount quoted by this API.
///
/// ## Viewing current and historical state
///
/// Most integrations into the Accudo blockchain benefit from a holistic and comprehensive overview of the current and historical state of the blockchain. Accudo provides historical transactions, state, and events, all the result of transaction execution.
///
...
///
/// Events and transactions pruning can be disabled via setting the [`enable_ledger_pruner`](https://github.com/accudo-labs/accudo-core/blob/cf0bc2e4031a843cdc0c04e70b3f7cd92666afcf/config/src/config/storage_config.rs#L141) to `false`. This is default behavior in Mainnet. In the near future, Accudo will provide indexers that mitigate the need to directly query from a node.
///
/// The REST API offers querying transactions and events in these ways:
///
/// * [Transactions for an account](https://fullnode.devnet.accudo.org/v1/spec#/operations/get_account_transactions)
/// * [Transactions by version](https://fullnode.devnet.accudo.org/v1/spec#/operations/get_transaction_by_version)
/// * [Events by event handle](https://fullnode.devnet.accudo.org/v1/spec#/operations/get_events_by_event_handle)
///
/// ## Exchanging and tracking coins
///
/// Accudo has a standard [Coin type](https://github.com/accudo-labs/accudo-core/blob/main/accudo-move/framework/accudo-framework/sources/coin.move). Different types of coins can be represented in this type through the use of distinct structs that represent the type parameter or generic for `Coin<T>`.
///
/// Coins are stored within an account under the resource `CoinStore<T>`. At account creation, each user has the resource `CoinStore<0x1::accudo_coin::AccudoCoin>` or `CoinStore<AccudoCoin>`, for short. Within this resource is the Accudo coin: `Coin<AccudoCoin>`.
///
/// ### Transferring coins between users
///
/// Coins can be transferred between users via the [`coin::transfer`](https://github.com/accudo-labs/accudo-core/blob/36a7c00b29a457469264187d8e44070b2d5391fe/accudo-move/framework/accudo-framework/sources/coin.move#L307) function for all coins and [`accudo_account::transfer`](https://github.com/accudo-labs/accudo-core/blob/88c9aab3982c246f8aa75eb2caf8c8ab1dcab491/accudo-move/framework/accudo-framework/sources/accudo_account.move#L18) for Accudo coins. The advantage of the latter function is that it creates the destination account if it does not exist.
///
/// :::caution
...
///
/// The current balance for a `Coin<T>` where `T` is the Accudo coin is available at the account resources URL: `https://{rest_api_server}/accounts/{address}/resource/0x1::coin::CoinStore<0x1::accudo_coin::AccudoCoin>`. The balance is stored within `coin::amount`. The resource also contains the total number of deposit and withdraw events, and the `counter` value within `deposit_events` and `withdraw_events`, respectively.
///
/// ```
/// {
///   "type": "0x1::coin::CoinStore<0x1::accudo_coin::AccudoCoin>",
///   "data": {
///     "coin": {
///       "value": "3927"
///     },
...
///
/// In Accudo, each transaction is committed as a distinct version to the blockchain. This allows for the convenience of sharing committed transactions by their version number; to do so, query: `https://{rest_server_api}/transactions/by_version/{version}`
///
...
/// :::tip
///
/// When tracking full movement of coins, normally events are sufficient. `0x1::accudo_coin::AccudoCoin`, however, requires considering `gas_used` for each transaction sent from the given account since it represents gas in Accudo. To reduce unnecessary overhead, extracting gas fees due to transactions does not emit an event. All transactions for an account can be retrieved from this API: `https://{rest_server_api}/accounts/{address}/transactions`
///
/// :::
///
...
/// 3. A gas fee `2200` of `0x1::accudo_coin::AccudoCoin` from the sending account `0x810026ca8291dd88b5b30a1d3ca2edd683d33d06c4a7f7c451d96f6d47bc5e8b`
///
...
/// 2. Gas is always: `0x1::accudo_coin::AccudoCoin`
///
...
///
/// This tutorial is for SDK and wallet developers who want to integrate with the [Accudo Faucet](https://github.com/accudo-labs/accudo-core/tree/main/crates/accudo-faucet). If you are a dapp developer, you should access the faucet through an existing [SDK](../tutorials/first-transaction.md) or [CLI](../tools/accudo-cli-tool/use-accudo-cli#initialize-local-configuration-and-create-an-account) instead.
///
...
/// - Devnet: https://faucet.devnet.accudo.org
/// - Testnet: https://faucet.testnet.accudo.org
///
/// ### Calling the faucet: JavaScript / TypeScript
/// If you are building a client in JavaScript or TypeScript, you should make use of the [@accudo-labs/accudo-faucet-client](https://www.npmjs.com/package/@accudo-labs/accudo-faucet-client) package. This client is generated based on the OpenAPI spec published by the faucet service.
///
/// Example use:
/// ```typescript
/// import {
///   AccudoFaucetClient,
///   FundRequest,
/// } from "@accudo-labs/accudo-faucet-client";
///
/// async function callFaucet(amount: number, address: string): Promise<string[]> {
///   const faucetClient = new AccudoFaucetClient({BASE: "https://faucet.devnet.accudo.org"});
...
/// 1. Generate a client from the [OpenAPI spec](https://github.com/accudo-labs/accudo-core/blob/main/crates/accudo-faucet/doc/spec.yaml).
/// 2. Call the faucet on your own.
///
/// For the latter, you will want to build a query similar to this:
/// ```
/// curl -X POST 'https://faucet.devnet.accudo.org/mint?amount=10000&address=0xd0f523c9e73e6f3d68c16ae883a9febc616e484c4998a72d8899a1009e5a89d6'
/// ```
///
