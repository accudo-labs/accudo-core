...
module raffle::raffle {
    ...
    use accudo_framework::coin::Coin;
    use std::signer;
    use std::vector;
    ...
    struct Raffle has key {
        ...
        // See [AIP-41](https://github.com/accudo-foundation/AIPs/blob/main/aips/aip-41.md#undergasing-attacks).
    ...
    public entry fun buy_a_ticket(user: &signer) acquires Raffle {
        ...
        let coins = coin::withdraw<AccudoCoin>(user, TICKET_PRICE);
    ...
    /// [AIP-41](https://github.com/accudo-foundation/AIPs/blob/main/aips/aip-41.md)).
    ...
    /// **test-and-abort** attacks (see [AIP-41](https://github.com/accudo-foundation/AIPs/blob/main/aips/aip-41.md)).
    ///
    ...
    public(friend) fun randomly_pick_winner_internal(): address acquires Raffle {
        ...
        coin::deposit<AccudoCoin>(winner, coins);
