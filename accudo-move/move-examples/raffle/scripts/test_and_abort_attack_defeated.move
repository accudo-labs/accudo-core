script {
    ...
    fun main(attacker: &signer) {
        ...
        let old_balance = coin::balance<accudo_coin::AccudoCoin>(attacker_addr);
        ...
        //    |- /tmp/accudo-core/accudo-move/move-examples/raffle/scripts/test_and_abort_attack_defeated.move:19:9
        //    |
        ...
        //    |
        //    |- /tmp/accudo-core/accudo-move/move-examples/raffle/sources/raffle.move:122:15
        //    |
        ...
        let new_balance = coin::balance<accudo_coin::AccudoCoin>(attacker_addr);
