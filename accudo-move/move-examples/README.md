...
1. Clone this repo by running `git clone https://github.com/accudo-labs/accudo-core.git`
2. Open a new terminal and navigate to this folder by running `cd accudo-move/move-examples`
3. Navigate into the specific tutorial you are interested (ex. `cd hello_blockchain`)
4. You can use the Accudo CLI to compile, test, publish, and run these contracts by using the commands outlined here: https://accudo.dev/move/move-on-accudo/cli/
     - If you need to install the Accudo CLI, you can follow these instructions: https://accudo.dev/tools/accudo-cli/install-cli/
...
-  [Accudo Learn](https://learn.accudo.org/code-examples/) provides more step-by-step guides on some high-quality examples. 
- We also have another repo [move-by-examples](https://github.com/accudo-labs/move-by-examples). It has more newer examples and is actively maintained.
