...
module marketplace::test_utils {
    ...
    use accudo_token_objects::accudo_token;
    ...
    public fun mint_tokenv2_with_collection(seller: &signer): (Object<Collection>, Object<Token>) {
        ...
        let collection_object = accudo_token::create_collection_object(
            seller,
        ...
        let accudo_token = accudo_token::mint_token_object(
            seller,
            collection_name,
        ...
        (object::convert(collection_object), object::convert(accudo_token))
    }
