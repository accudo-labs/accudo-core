...
/// - 1.a run `accudo init --profile admin` to create an admin account
...
/// Run the following command in directory `accudo-core/accudo-move/move-examples/mint_nft/3-Adding-Admin`.
...
/// example output:
    /*
    3-Adding-Admin % accudo move create-resource-account-and-publish-package --seed 1239 --address-name mint_nft --profile default --named-addresses source_addr=a911e7374107ad434bbc5369289cf5855c3b1a2938a6bfce0776c1d296271cde

    Compiling, may take a little while to download git dependencies...
    INCLUDING DEPENDENCY AccudoFramework
    INCLUDING DEPENDENCY AccudoStdlib
    INCLUDING DEPENDENCY AccudoToken
...
/// accudo move run --function-id [resource account's address]::create_nft_with_resource_and_admin_accounts::mint_event_ticket --profile nft-receiver
/// example output:
    /*
    3-Adding-Admin % accudo move run --function-id 34f5acaaef16988aa31bb56ad7b35e30d14ff9fc849d370be799617b61d3df04::create_nft_with_resource_and_admin_accounts::mint_event_ticket --profile nft-receiver
    {
...
/// accudo move run --function-id [resource account's address]::create_nft_with_resource_and_admin_accounts::set_minting_enabled --args bool:true --profile admin
/// example output:
    /*
    3-Adding-Admin % accudo move run --function-id 34f5acaaef16988aa31bb56ad7b35e30d14ff9fc849d370be799617b61d3df04::create_nft_with_resource_and_admin_accounts::set_minting_enabled --args bool:true --profile admin
...
/// example output:
    ...
    */
/// - 4.d Check out the transactions on https://explorer.accudo.org/ by searching for the transaction hash.
module mint_nft::create_nft_with_resource_and_admin_accounts {
    use std::error;
    use std::string;
    use std::vector;

    use accudo_token::token;
    use std::signer;
    use std::string::String;
    use accudo_token::token::TokenDataId;
    use accudo_framework::account::SignerCapability;
    ...
    /// See https://accudo.dev/concepts/accounts/#resource-accounts for more details.
