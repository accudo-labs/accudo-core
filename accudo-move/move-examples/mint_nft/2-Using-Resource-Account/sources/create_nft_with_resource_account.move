...
/// accudo init --profile nft-receiver
///
/// 2. Publish the module under a resource account.
/// - 2.a Make sure you're in the right directory.
/// Run the following command in directory `accudo-core/accudo-move/move-examples/mint_nft/2-Using-Resource-Account`
...
/// example output:
    /*
    2-Using-Resource-Account % accudo move create-resource-account-and-publish-package --seed 1235 --address-name mint_nft --profile default --named-addresses source_addr=a911e7374107ad434bbc5369289cf5855c3b1a2938a6bfce0776c1d296271cde
...
/// accudo move run --function-id [resource account's address]::create_nft_with_resource_account::mint_event_ticket --profile nft-receiver
///
/// example output:
    /*
    2-Using-Resource-Account % accudo move run --function-id 55328567ff8aa7d242951af7fc1872746fbeeb89dfed0e1ee2ff71b9bf4469d6::create_nft_with_resource_account::mint_event_ticket --profile nft-receiver
    ...
    */
/// - 4.b Check out the transaction on https://explorer.accudo.org/ by searching for the transaction hash.
module mint_nft::create_nft_with_resource_account {
    ...
    /// See https://accudo.dev/concepts/accounts/#resource-accounts for more information about resource account.
