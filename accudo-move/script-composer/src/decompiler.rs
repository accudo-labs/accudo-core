...
impl LocalState {
    ...
    fn type_tag_from_sig_token(
        ...
        Ok(match token {
            ...
            SignatureToken::Function(_args, _result, _abilities) => {
                // TODO(#15664): implement function types
...
pub fn generate_batched_call_payload(
    ...
    if !compiled_script
        .metadata
        .iter()
        .any(|md| md.key == ACCUDO_SCRIPT_COMPOSER_KEY && md.value == expected_version)
    {
