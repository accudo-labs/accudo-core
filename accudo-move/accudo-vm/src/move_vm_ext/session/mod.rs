...
use crate::{
    ...
    move_vm_ext::{
        resource_state_key, write_op_converter::WriteOpConverter, AccudoMoveResolver, SessionId,
    },
};
use accudo_framework::natives::{
...
use accudo_table_natives::{NativeTableContext, TableChangeSet};
use accudo_types::{
...
use accudo_vm_types::{
    change_set::VMChangeSet, module_and_script_storage::module_storage::AccudoModuleStorage,
    ...
    R: AccudoMoveResolver,
{
    pub(crate) fn new(
        ...
        let extensions = make_accudo_extensions(
            resolver,
            chain_id,
            vm_config,
            session_id,
...
/// Initializes and returns Accudo native extensions.
pub(crate) fn make_accudo_extensions<'a, DataView>(
