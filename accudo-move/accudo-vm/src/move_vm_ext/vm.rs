...
use crate::move_vm_ext::{AccudoMoveResolver, SessionExt, SessionId};
...
use accudo_vm_environment::{
    ...
    prod_configs::{accudo_default_ty_builder, accudo_prod_vm_config},
};
use accudo_vm_types::storage::change_set_configs::ChangeSetConfigs;
...
impl GenesisRuntimeBuilder {
    ...
    pub fn new(chain_id: ChainId) -> Self {
        ...
        let vm_config = accudo_prod_vm_config(
            LATEST_GAS_FEATURE_VERSION,
            &features,
            &timed_features,
            accudo_default_ty_builder(),
        );
        ...
        let natives = accudo_natives_with_builder(&mut native_builder, false);
...
impl GenesisMoveVm {
    ...
    pub fn new_genesis_session<'r, R: AccudoMoveResolver>(
        &self,
        resolver: &'r R,
...
pub struct MoveVmExt {
    pub(crate) env: AccudoEnvironment,
}

impl MoveVmExt {
    pub fn new(env: &AccudoEnvironment) -> Self {
        Self { env: env.clone() }
    }
