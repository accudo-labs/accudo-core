...
use crate::move_vm_ext::{session::BytesWithResourceLayout, AccudoMoveResolver};
use accudo_aggregator::delta_change_set::serialize;
use accudo_types::{
...
pub(crate) struct WriteOpConverter<'r> {
    remote: &'r dyn AccudoMoveResolver,
...
mod tests {
    ...
    use accudo_vm_types::{
        module_and_script_storage::AsAccudoCodeStorage,
    ...
    // TODO: Can re-use some of these testing definitions with accudo-vm-types.
