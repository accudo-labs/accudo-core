...
use accudo_block_executor::{
    code_cache_global_manager::AccudoModuleCacheManager, txn_provider::default::DefaultTxnProvider,
};
    ...
    pub fn execute_transactions_with_dependencies(
        ...
        executor_thread_pool.clone().scope(|s| {
            ...
            s.spawn(move |_| {
                ...
                let ret = AccudoVMBlockExecutorWrapper::execute_block_on_thread_pool(
                    executor_thread_pool,
                    &txn_provider,
