...
use accudo_vm_logging::{flush_speculative_logs, init_speculative_logs};
use accudo_vm_types::{
...
use vm_wrapper::AccudoExecutorTask;
...
impl BlockExecutorTransactionOutput for AccudoTransactionOutput {
...
pub struct AccudoBlockExecutorWrapper<
    E: ExecutorTask<
        Txn = SignatureVerifiedTransaction,
        Error = VMStatus,
        Output = AccudoTransactionOutput,
    >,
> {
...
// Same as AccudoBlockExecutorWrapper with AccudoExecutorTask
pub type AccudoVMBlockExecutorWrapper = AccudoBlockExecutorWrapper<AccudoExecutorTask>;
