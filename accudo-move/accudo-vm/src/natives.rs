...
#[cfg(feature = "testing")]
use accudo_aggregator::resolver::TAggregatorV1View;
#[cfg(feature = "testing")]
use accudo_aggregator::{bounded_math::SignedU128, types::DelayedFieldsSpeculativeError};
#[cfg(feature = "testing")]
use accudo_aggregator::{resolver::TDelayedFieldView, types::DelayedFieldValue};
#[cfg(feature = "testing")]
use accudo_framework::natives::randomness::RandomnessContext;
#[cfg(feature = "testing")]
use accudo_framework::natives::{cryptography::algebra::AlgebraContext, event::NativeEventContext};
use accudo_gas_schedule::{MiscGasParameters, NativeGasParameters, LATEST_GAS_FEATURE_VERSION};
use accudo_native_interface::SafeNativeBuilder;
#[cfg(feature = "testing")]
use accudo_table_natives::{TableHandle, TableResolver};
use accudo_types::on_chain_config::{Features, TimedFeatures, TimedFeaturesBuilder};
#[cfg(feature = "testing")]
use accudo_types::{
    chain_id::ChainId,
...
use accudo_vm_environment::natives::accudo_natives_with_builder;
#[cfg(feature = "testing")]
use bytes::Bytes;
#[cfg(feature = "testing")]
...
#[cfg(feature = "testing")]
struct AccudoBlankStorage;

#[cfg(feature = "testing")]
impl AccudoBlankStorage {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[cfg(feature = "testing")]
impl TAggregatorV1View for AccudoBlankStorage {
...
#[cfg(feature = "testing")]
impl TDelayedFieldView for AccudoBlankStorage {
...
#[cfg(feature = "testing")]
impl TableResolver for AccudoBlankStorage {
...
static DUMMY_RESOLVER: Lazy<AccudoBlankStorage> = Lazy::new(|| AccudoBlankStorage::new());

pub fn accudo_natives(
    ...
    accudo_natives_with_builder(&mut builder, false)
}
...
fn unit_test_extensions_hook(exts: &mut NativeContextExtensions) {
    use accudo_framework::natives::object::NativeObjectContext;
    use accudo_table_natives::NativeTableContext;
