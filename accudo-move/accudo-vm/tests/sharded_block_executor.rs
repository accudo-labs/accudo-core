...
/// accudo-vm and accudo-language-e2e-tests, which causes static variables to have two instances in
...
mod test_utils {
    ...
    use accudo_block_partitioner::BlockPartitioner;
    use accudo_keygen::KeyGen;
    use accudo_language_e2e_tests::common_transactions::peer_to_peer_txn;
    ...
    use accudo_vm::{
        accudo_vm::AccudoVMBlockExecutor,
    ...
    pub fn test_sharded_block_executor_no_conflict<E: ExecutorClient<InMemoryStateStore>>(
        ...
        let unsharded_txn_output = AccudoVMBlockExecutor::new()
