...
module accudo_std::single_key {
    use accudo_std::bcs_stream::{Self, deserialize_u8};
    use accudo_std::ed25519;
    use accudo_std::keyless;
    use accudo_std::secp256k1;
    use accudo_std::secp256r1;
    use accudo_std::bcs;
    use accudo_std::federated_keyless;
    use std::error;
    use std::hash;
    ...
    /// The identifier of the Single Key signature scheme, which is used when deriving Accudo authentication keys by hashing
