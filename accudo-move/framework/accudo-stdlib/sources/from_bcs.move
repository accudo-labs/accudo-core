...
/// a general conversion back-and-force is needed, consider the `accudo_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
module accudo_std::from_bcs {
    ...
    friend accudo_std::any;
    friend accudo_std::copyable_any;
