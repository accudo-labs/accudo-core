...
/// - Exception: For the `deserialize_address` function, the function-based approach from `accudo_std::from_bcs` is used
...
module accudo_std::bcs_stream {
    ...
    /// This function utilizes the `to_address` function from the `accudo_std::from_bcs` module,
