...
Random signature generated by running <code>cargo test -- bls12381_sample_signature --nocapture --<b>include</b>-ignored</code> in <code>crates/accudo-crypto</code>.
...
<b>ensures</b> <a href="bls12381.md#0x1_bls12381_spec_validate_pubkey_internal">spec_validate_pubkey_internal</a>(bytes) ==&gt; (std::option::is_some(result) && std::option::borrow(result).bytes == bytes);
...
<b>ensures</b> <a href="bls12381.md#0x1_bls12381_spec_verify_proof_of_possession_internal">spec_verify_proof_of_possession_internal</a>(pk_bytes, pop.bytes) ==&gt; (std::option::is_some(result) && std::option::borrow(result).bytes == pk_bytes);
...
<b>ensures</b> success ==&gt; (std::option::is_some(result) && std::option::borrow(result).bytes == bytes);
