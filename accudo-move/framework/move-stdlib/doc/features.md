...
Defines feature flags for Accudo. Those are used in Accudo specific implementations of features in
the Move stdlib, the Accudo stdlib, and the Accudo framework.
...
-  [Function `get_accudo_stdlib_chain_id_feature`](#0x1_features_get_accudo_stdlib_chain_id_feature)
-  [Function `accudo_stdlib_chain_id_enabled`](#0x1_features_accudo_stdlib_chain_id_enabled)
...
<a id="0x1_features_ACCUDO_STD_CHAIN_ID_NATIVES"></a>

Whether the new <code>accudo_stdlib::type_info::chain_id()</code> native for fetching the chain ID is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_ACCUDO_STD_CHAIN_ID_NATIVES">ACCUDO_STD_CHAIN_ID_NATIVES</a>: u64 = 4;
</code></pre>



<a id="0x1_features_ACCUDO_UNIQUE_IDENTIFIERS"></a>

Whether enable MOVE functions to call create_auid method to create AUIDs.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_ACCUDO_UNIQUE_IDENTIFIERS">ACCUDO_UNIQUE_IDENTIFIERS</a>: u64 = 23;
</code></pre>
...
Deprecated by <code>accudo_framework::jwk_consensus_config::JWKConsensusConfig</code>.
...
Whether accudo_framwork enables the behavior of module event migration.
...
Whether the new <code>accudo_stdlib::multi_ed25519::public_key_validate_internal_v2()</code> native is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient
...
Whether enable paritial governance voting on accudo_governance.
Lifetime: transient
...
Deprecated by <code>accudo_framework::randomness_config::RandomnessConfig</code>.
...
<a id="0x1_features_get_accudo_stdlib_chain_id_feature"></a>

## Function `get_accudo_stdlib_chain_id_feature`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_accudo_stdlib_chain_id_feature">get_accudo_stdlib_chain_id_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_accudo_stdlib_chain_id_feature">get_accudo_stdlib_chain_id_feature</a>(): u64 { <a href="features.md#0x1_features_ACCUDO_STD_CHAIN_ID_NATIVES">ACCUDO_STD_CHAIN_ID_NATIVES</a> }
</code></pre>
...
<a id="0x1_features_accudo_stdlib_chain_id_enabled"></a>

## Function `accudo_stdlib_chain_id_enabled`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_accudo_stdlib_chain_id_enabled">accudo_stdlib_chain_id_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_accudo_stdlib_chain_id_enabled">accudo_stdlib_chain_id_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_ACCUDO_STD_CHAIN_ID_NATIVES">ACCUDO_STD_CHAIN_ID_NATIVES</a>)
}
</code></pre>
