...
module std::features {
    ...
    /// Whether the new `accudo_stdlib::type_info::chain_id()` native for fetching the chain ID is enabled.
    /// This is needed because of the introduction of a new native function.
    /// Lifetime: transient
    const ACCUDO_STD_CHAIN_ID_NATIVES: u64 = 4;

    public fun get_accudo_stdlib_chain_id_feature(): u64 { ACCUDO_STD_CHAIN_ID_NATIVES }

    public fun accudo_stdlib_chain_id_enabled(): bool acquires Features {
        is_enabled(ACCUDO_STD_CHAIN_ID_NATIVES)
    }
    ...
    /// Whether the new `accudo_stdlib::multi_ed25519::public_key_validate_internal_v2()` native is enabled.
    /// This is needed because of the introduction of a new native function.
    /// Lifetime: transient
    ...
    /// Lifetime: transient
    const ACCUDO_UNIQUE_IDENTIFIERS: u64 = 23;
    ...
    /// Deprecated by `accudo_framework::randomness_config::RandomnessConfig`.
    ...
    /// Deprecated by `accudo_framework::jwk_consensus_config::JWKConsensusConfig`.
