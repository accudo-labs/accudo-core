...
<tr>
<td>2</td>
<td>The governance proposal module should only be accessible to the accudo governance.</td>
<td>Medium</td>
<td>Both create_proposal and create_empty_proposal functions are only available to the friend module accudo_framework::accudo_governance.</td>
