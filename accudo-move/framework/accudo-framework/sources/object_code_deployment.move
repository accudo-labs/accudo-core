...
module accudo_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use accudo_framework::code;
    use accudo_framework::code::PackageRegistry;
    use accudo_framework::event;
    use accudo_framework::object;
    use accudo_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"accudo_framework::object_code_deployment";
