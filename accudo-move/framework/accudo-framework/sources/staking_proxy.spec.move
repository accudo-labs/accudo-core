spec accudo_framework::staking_proxy {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced via [https://github.com/accudo-labs/accudo-core/blob/main/accudo-move/framework/accudo-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
    ...
    spec schema SetStakingContractOperator {
        ...
        use accudo_framework::staking_contract::{Store};
