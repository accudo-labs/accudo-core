...
module accudo_framework::chain_status {
    ...
    public(friend) fun set_genesis_end(accudo_framework: &signer) {
        system_addresses::assert_accudo_framework(accudo_framework);
        move_to(accudo_framework, GenesisEndMarker {});
    }

    #[view]
    /// Helper function to determine if Accudo is in genesis state.
    public fun is_genesis(): bool {
        !exists<GenesisEndMarker>(@accudo_framework)
    }
