...
module accudo_framework::object {
    use std::bcs;
    use std::error;
    use std::hash;
    use std::signer;
    ...
    fun test_correct_auid() {
        let auid1 = accudo_framework::transaction_context::generate_auid_address();
        let bytes = accudo_framework::transaction_context::get_transaction_hash();
        ...
        let auid2 = accudo_framework::from_bcs::to_address(std::hash::sha3_256(bytes));
