...
module accudo_framework::fungible_asset {
    ...
    use accudo_framework::object::{Self, Object, ConstructorRef, DeleteRef, ExtendRef};
    ...
    friend accudo_framework::primary_fungible_store;
    friend accudo_framework::accudo_account;

    friend accudo_framework::dispatchable_fungible_asset;
    ...
    fun has_deposit_dispatch_function(
        ...
        if (metadata_addr != @accudo_fungible_asset
            && exists<DispatchFunctionStore>(metadata_addr)) {
            option::is_some(
                &borrow_global<DispatchFunctionStore>(metadata_addr).deposit_function
            )
    ...
    public fun balance_with_ref<T: key>(
        ref: &RawBalanceRef, store: Object<T>
    ...
    public fun supply_with_ref<T: key>(
        ref: &RawSupplyRef, metadata: Object<T>
    ...
    public fun revoke_permission(
        _permissioned: &signer, _token_type: Object<Metadata>
    ) {
        abort 0
    }
    ...
    fun test_mutate_metadata(creator: &signer) acquires Metadata {
        ...
        mutate_metadata(
            ...
            option::some(
                string::utf8(b"http://www.mutated-example.com")
            )
        );
    ...
    fun create_exceedingly_long_uri(): vector<u8> {
        ...
        let too_long_of_uri =
            b"mutated_uri_will_be_too_long_for_the_maximum_length_check.com/";
        for (i in 0..50) {
    ...
    #[test(fx = @accudo_framework, creator = @0xcafe)]
    ...
    fun test_e2e_withdraw_limit(
        ...
        let accudo_framework = account::create_signer_for_test(@0x1);
