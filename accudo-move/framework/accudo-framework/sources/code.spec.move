spec accudo_framework::code {
    ...
    /// Enforcement: The Accudo upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(accudo_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {
