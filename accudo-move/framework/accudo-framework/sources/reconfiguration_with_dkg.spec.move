spec accudo_framework::reconfiguration_with_dkg {
    spec module {
        pragma verify = true;
    }
    ...
    spec try_start() {
        ...
        requires exists<reconfiguration::Configuration>(@accudo_framework);
    ...
    spec schema FinishRequirement {
        ...
        framework: signer;
        requires signer::address_of(framework) == @accudo_framework;
        requires chain_status::is_operating();
