module accudo_framework::common_account_abstractions_utils {
    use accudo_framework::auth_data::AbstractionAuthData;
    use std::chain_id;
    use std::string_utils;
    use std::transaction_context::{Self, EntryFunctionPayload};

    friend accudo_framework::ethereum_derivable_account;
    friend accudo_framework::solana_derivable_account;
    friend accudo_framework::sui_derivable_account;
