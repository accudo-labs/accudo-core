module accudo_framework::rate_limiter {
    ...
    fun test_initialize_bucket(accudo_framework: &signer) {
    ...
    #[test(accudo_framework = @0x1)]
    fun test_request_success(accudo_framework: &signer) {
        timestamp::set_time_has_started_for_testing(accudo_framework);
    ...
    #[test(accudo_framework = @0x1)]
    fun test_request_failure(accudo_framework: &signer) {
        timestamp::set_time_has_started_for_testing(accudo_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(accudo_framework = @0x1)]
    fun test_refill(accudo_framework: &signer) {
        timestamp::set_time_has_started_for_testing(accudo_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(accudo_framework= @0x1)]
    fun test_fractional_accumulation(accudo_framework: &signer) {
        timestamp::set_time_has_started_for_testing(accudo_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(accudo_framework= @0x1)]
    fun test_multiple_refills(accudo_framework: &signer) {
        timestamp::set_time_has_started_for_testing(accudo_framework);
        let bucket = initialize(10, 60);
