...
module accudo_framework::optional_aggregator {
    use std::error;
    use std::option::{Self, Option};

    use accudo_framework::aggregator_factory;
    use accudo_framework::aggregator::{Self, Aggregator};
    ...
    #[test(account = @accudo_framework)]
    #[expected_failure(abort_code = 0x020001, location = accudo_framework::aggregator)]
    ...
    #[test(account = @accudo_framework)]
    #[expected_failure(abort_code = 0x020002, location = accudo_framework::aggregator)]
