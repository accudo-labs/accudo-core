...
module accudo_framework::code {
    ...
    friend accudo_framework::object_code_deployment;
    ...
    fun initialize(accudo_framework: &signer, package_owner: &signer, metadata: PackageMetadata)
