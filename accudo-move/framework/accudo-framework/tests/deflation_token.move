...
module 0xcafe::deflation_token {
    use accudo_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use accudo_framework::dispatchable_fungible_asset;
    use accudo_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use accudo_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=accudo_framework::dispatchable_fungible_asset)]
