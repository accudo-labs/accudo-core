#[test_only]
module accudo_framework::delegation_pool_integration_tests {
    use std::features;
    use std::signer;

    use accudo_std::bls12381;
    use accudo_std::stake;
    use accudo_std::vector;
    ...
    use accudo_framework::delegation_pool as dp;
    ...
    public fun initialize_for_test_custom(
        ...
        features::change_feature_flags_for_testing(accudo_framework, vector[DELEGATION_POOLS, MODULE_EVENT], vector[]);
    }
    ...
    #[expected_failure(abort_code = 0x10007, location = accudo_framework::stake)]
    ...
    public entry fun test_end_to_end(
        ...
        assert!(coin::balance<AccudoCoin>(validator_address) == 800 * ONE_APT, 2);
        ...
        assert!(coin::balance<AccudoCoin>(validator_address) == 84999999999, 6);
        stake::assert_validator_state(pool_address, 10201000001, 5099999999, 0, 0, 0);
        dp::withdraw(validator, pool_address, 51 * ONE_APT);
        assert!(coin::balance<AccudoCoin>(validator_address) == 90099999998, 7);
    ...
    #[test(accudo_framework = @accudo_framework, validator_1 = @0x123, validator_2 = @0x234)]
    #[expected_failure(abort_code = 0x1000D, location = accudo_framework::stake)]
    ...
    #[test(accudo_framework = @accudo_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x10006, location = accudo_framework::delegation_pool)]
    ...
    public entry fun test_active_validator_withdraw_should_cap_by_inactive_stake(
        ...
        assert!(coin::balance<AccudoCoin>(signer::address_of(validator)) == 100100000000, 2);
    ...
    public entry fun test_delegated_staking_with_owner_cap(
        ...
        assert!(coin::balance<AccudoCoin>(signer::address_of(validator)) == 101 * ONE_APT, 1);
    ...
    #[test(accudo_framework = @accudo_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = accudo_framework::stake)]
    ...
    #[test(accudo_framework = @accudo_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000E, location = accudo_framework::stake)]
    ...
    #[test(accudo_framework = @accudo_framework, validator = @0x123)]
    #[expected_failure(abort_code = 0x1000B, location = accudo_framework::stake)]
    ...
    public entry fun test_removing_validator_from_active_set(
        ...
        stake::remove_validators(accudo_framework, &vector[validator_to_remove]);
