...
fn main() -> Result<()> {
    ...
    if std::env::var("SKIP_FRAMEWORK_BUILD").is_err() {
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("accudo-token").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("accudo-token").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("accudo-framework").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("accudo-stdlib").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("accudo-stdlib").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
