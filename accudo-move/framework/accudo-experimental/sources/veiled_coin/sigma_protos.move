...
module accudo_experimental::sigma_protos {
    use std::error;
    ...
    use accudo_std::ristretto255::{Self, RistrettoPoint, Scalar};

    use accudo_experimental::helpers::cut_vector;
    ...
    const FIAT_SHAMIR_SIGMA_DST: vector<u8> = b"AccudoVeiledCoin/WithdrawalSubproofFiatShamir";
