#[test_only]
module accudo_experimental::clearinghouse_test {
    #[test_only] friend accudo_experimental::market_single_order_tests;
    #[test_only] friend accudo_experimental::pre_cancellation_tests;
    #[test_only] friend accudo_experimental::market_tests_common;
    #[test_only] friend accudo_experimental::market_test_utils;
    #[test_only] friend accudo_experimental::market_bulk_order_tests;
    #[test_only] friend accudo_experimental::market_mixed_order_tests;
    ...
    use accudo_experimental::market_types::{
        SettleTradeResult,
    ...
    MarketClearinghouseCallbacks<TestOrderMetadata, u64> acquires GlobalState {
        new_market_clearinghouse_callbacks(
            ...
            |_order_info, _size| {
                new_place_maker_order_result(option::some(std::string::utf8(b"cancelled")), option::none())
            },
            |order_info, _remaining_size, _| {
                cleanup_order(order_info.get_order_id());
            },
