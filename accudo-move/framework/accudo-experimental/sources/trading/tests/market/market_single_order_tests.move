#[test_only]
module accudo_experimental::market_single_order_tests {
    use std::option;
    ...
    use accudo_experimental::order_placement::{place_market_order, place_limit_order};
    use accudo_experimental::event_utils::latest_emitted_events;
    use accudo_experimental::clearinghouse_test;
    use accudo_experimental::clearinghouse_test::{
        test_market_callbacks,
        new_test_order_metadata,
        get_position_size, test_market_callbacks_with_maker_cancellled,
    };
    use accudo_experimental::market_test_utils::{
        place_order_and_verify,
        place_taker_order_and_verify_fill,
        place_taker_order,
        verify_cancel_event,
    };
    use accudo_experimental::event_utils;
    use accudo_experimental::market_types::{order_status_open};
    use accudo_experimental::market_types::{OrderEvent};
    use accudo_experimental::order_book_types::{OrderIdType, price_move_up_condition};
    use accudo_experimental::order_book_types::{good_till_cancelled};

    // Import common functions from market_tests
    use accudo_experimental::market_tests_common::{
        setup_market,
        place_maker_order,
        verify_positions,
    ...
    #[test(
       accudo_framework = @0x1, admin = @0x1, market_signer = @0x123, maker1 = @0x456, maker2 = @0x789
    )]
    public fun test_self_matching_allowed(
        ...
        test_self_matching_allowed_helper(accudo_framework, admin, market_signer, maker1, maker2, false);
    }
    ...
    #[test(accudo_framework = @0x1, admin = @0x1, market_signer = @0x123, maker1 = @0x456)]
