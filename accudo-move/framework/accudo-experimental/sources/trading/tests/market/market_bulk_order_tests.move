#[test_only]
module accudo_experimental::market_bulk_order_tests {
    use std::option;
    use std::signer;
    ...
    public fun test_self_matching_allowed(
        ...
        test_self_matching_allowed_helper(accudo_framework, admin, market_signer, maker1, maker2, true);
    }
    ...
    public fun test_bulk_order_cancellation_event_fields(
        ...
        use accudo_experimental::market_types::{BulkOrderModifiedEvent, verify_bulk_order_modified_event};
        use accudo_experimental::market_bulk_order::cancel_bulk_order;
        use accudo_experimental::event_utils::{new_event_store, latest_emitted_events};
