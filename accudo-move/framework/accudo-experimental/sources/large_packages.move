...
/// SDK: [`accudo-python-sdk`](https://github.com/accudo-labs/accudo-python-sdk/blob/main/accudo_sdk/package_publisher.py).
///
/// Accudo CLI supports this as well with `--chunked-publish` flag:
/// - `accudo move publish [OPTIONS] --chunked-publish`
/// - `accudo move create-object-and-publish-package [OPTIONS] --address-name <ADDRESS_NAME> --chunked-publish`
/// - `accudo move upgrade-object-package [OPTIONS] --address-name <ADDRESS_NAME> --chunked-publish`
///
/// # Usage
///
/// 1. **Stage Code Chunks**:
...
module accudo_experimental::large_packages {
    use std::error;
    use std::signer;
    use std::vector;
    use accudo_std::smart_table::{Self, SmartTable};

    use accudo_framework::code::{Self, PackageRegistry};
    use accudo_framework::object::{Object};
    use accudo_framework::object_code_deployment;
