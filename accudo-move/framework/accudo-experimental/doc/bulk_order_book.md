...
<dl>
<dt>
<code>orders: <a href="../../accudo-framework/doc/big_ordered_map.md#0x1_big_ordered_map_BigOrderedMap">big_ordered_map::BigOrderedMap</a>&lt;<b>address</b>, <a href="bulk_order_book_types.md#0x7_bulk_order_book_types_BulkOrder">bulk_order_book_types::BulkOrder</a>&lt;M&gt;&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>order_id_to_address: <a href="../../accudo-framework/doc/big_ordered_map.md#0x1_big_ordered_map_BigOrderedMap">big_ordered_map::BigOrderedMap</a>&lt;<a href="order_book_types.md#0x7_order_book_types_OrderIdType">order_book_types::OrderIdType</a>, <b>address</b>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_single_match_for_taker">get_single_match_for_taker</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    price_time_idx: &<b>mut</b> accudo_experimental::price_time_index::PriceTimeIndex,
...
<pre><code><b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_cancel_active_orders">cancel_active_orders</a>&lt;M: store + <b>copy</b> + drop&gt;(
    price_time_idx: &<b>mut</b> accudo_experimental::price_time_index::PriceTimeIndex, order: &BulkOrder&lt;M&gt;
) {
...
<pre><code><b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_activate_first_price_levels">activate_first_price_levels</a>&lt;M: store + <b>copy</b> + drop&gt;(
    price_time_idx: &<b>mut</b> accudo_experimental::price_time_index::PriceTimeIndex, order: &BulkOrder&lt;M&gt;, order_id: OrderIdType
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_reinsert_order">reinsert_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> <a href="../../accudo-framework/doc/account.md#0x1_account">account</a> = reinsert_order.get_account_from_match_details();
    <b>let</b> order_option = self.orders.remove_or_none(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>);
    ...
    self.orders.add(<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, order);
}
</code></pre>
...
- <code>self</code>: Mutable reference to the bulk order book
- <code>price_time_idx</code>: Mutable reference to the price time index
- <code><a href="../../accudo-framework/doc/account.md#0x1_account">account</a></code>: The account whose order should be cancelled
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_cancel_bulk_order">cancel_bulk_order</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<b>mut</b> <a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>&lt;M&gt;, price_time_idx: &<b>mut</b> <a href="price_time_index.md#0x7_price_time_index_PriceTimeIndex">price_time_index::PriceTimeIndex</a>, <a href="../../accudo-framework/doc/account.md#0x1_account">account</a>: <b>address</b>): <a href="bulk_order_book_types.md#0x7_bulk_order_book_types_BulkOrder">bulk_order_book_types::BulkOrder</a>&lt;M&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_cancel_bulk_order">cancel_bulk_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    // This allows us <b>to</b> reuse the order id for the same <a href="../../accudo-framework/doc/account.md#0x1_account">account</a> in the future without creating a new order.
    <b>let</b> order_opt = self.orders.remove_or_none(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_bulk_order">get_bulk_order</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>&lt;M&gt;, <a href="../../accudo-framework/doc/account.md#0x1_account">account</a>: <b>address</b>): <a href="bulk_order_book_types.md#0x7_bulk_order_book_types_BulkOrder">bulk_order_book_types::BulkOrder</a>&lt;M&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_bulk_order">get_bulk_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>if</b> (!self.orders.contains(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>)) {
        <b>abort</b> <a href="bulk_order_book.md#0x7_bulk_order_book_EORDER_NOT_FOUND">EORDER_NOT_FOUND</a>;
    };

    self.orders.get(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>).destroy_some()
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_remaining_size">get_remaining_size</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> result_option = self.orders.get_and_map(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, |order| order.get_total_remaining_size(is_bid));
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_prices">get_prices</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>&lt;M&gt;, <a href="../../accudo-framework/doc/account.md#0x1_account">account</a>: <b>address</b>, is_bid: bool): <a href="../../accudo-framework/../accudo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_prices">get_prices</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> result_option = self.orders.get_and_map(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, |order| order.get_all_prices(is_bid));
    <b>assert</b>!(result_option.is_some(), <a href="bulk_order_book.md#0x7_bulk_order_book_EORDER_NOT_FOUND">EORDER_NOT_FOUND</a>);
    result_option.destroy_some()
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_get_sizes">get_sizes</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> result_option = self.orders.get_and_map(&<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, |order| order.get_all_sizes(is_bid));
    <b>assert</b>!(result_option.is_some(), <a href="bulk_order_book.md#0x7_bulk_order_book_EORDER_NOT_FOUND">EORDER_NOT_FOUND</a>);
    result_option.destroy_some()
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_place_bulk_order">place_bulk_order</a>&lt;M: <b>copy</b>, drop, store&gt;(self: &<b>mut</b> <a href="bulk_order_book.md#0x7_bulk_order_book_BulkOrderBook">bulk_order_book::BulkOrderBook</a>&lt;M&gt;, price_time_idx: &<b>mut</b> <a href="price_time_index.md#0x7_price_time_index_PriceTimeIndex">price_time_index::PriceTimeIndex</a>, order_req: <a href="bulk_order_book_types.md#0x7_bulk_order_book_types_BulkOrderRequest">bulk_order_book_types::BulkOrderRequest</a>&lt;M&gt;): <a href="bulk_order_book_types.md#0x7_bulk_order_book_types_BulkOrderPlaceResponse">bulk_order_book_types::BulkOrderPlaceResponse</a>&lt;M&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="bulk_order_book.md#0x7_bulk_order_book_place_bulk_order">place_bulk_order</a>&lt;M: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> <a href="../../accudo-framework/doc/account.md#0x1_account">account</a> = get_account_from_order_request(&order_req);
    ...
    <b>let</b> (order_id, previous_seq_num) = <b>if</b> (order_option.is_some()) {
        ...
        <b>if</b> (new_sequence_number &lt;= existing_sequence_number) {
            ...
            self.orders.add(<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, old_order); // Re-add the <b>old</b> order back since we are rejecting the new one
        ...
        <b>let</b> order_id = new_order_id_type(<a href="../../accudo-framework/doc/transaction_context.md#0x1_transaction_context_monotonically_increasing_counter">transaction_context::monotonically_increasing_counter</a>());
        self.order_id_to_address.add(order_id, <a href="../../accudo-framework/doc/account.md#0x1_account">account</a>);
    ...
    self.orders.add(<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, bulk_order);
