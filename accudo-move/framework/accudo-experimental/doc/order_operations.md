...
<pre><code><b>public</b> <b>fun</b> <a href="order_operations.md#0x7_order_operations_cancel_order">cancel_order</a>&lt;M: store + <b>copy</b> + drop, R: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> order = market.get_order_book_mut().<a href="order_operations.md#0x7_order_operations_cancel_order">cancel_order</a>(<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, order_id);
...
<pre><code><b>public</b> <b>fun</b> <a href="order_operations.md#0x7_order_operations_try_cancel_order">try_cancel_order</a>&lt;M: <b>copy</b>, drop, store, R: <b>copy</b>, drop, store&gt;(market: &<b>mut</b> <a href="market_types.md#0x7_market_types_Market">market_types::Market</a>&lt;M&gt;, <a href="../../accudo-framework/doc/account.md#0x1_account">account</a>: <b>address</b>, order_id: <a href="order_book_types.md#0x7_order_book_types_OrderIdType">order_book_types::OrderIdType</a>, emit_event: bool, callbacks: &<a href="market_types.md#0x7_market_types_MarketClearinghouseCallbacks">market_types::MarketClearinghouseCallbacks</a>&lt;M, R&gt;): <a href="../../accudo-framework/../accudo-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="single_order_types.md#0x7_single_order_types_SingleOrder">single_order_types::SingleOrder</a>&lt;M&gt;&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="order_operations.md#0x7_order_operations_try_cancel_order">try_cancel_order</a>&lt;M: store + <b>copy</b> + drop, R: store + <b>copy</b> + drop&gt;(
    ...
    emit_event: bool,
    callbacks: &MarketClearinghouseCallbacks&lt;M, R&gt;
): <a href="../../accudo-framework/../accudo-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;SingleOrder&lt;M&gt;&gt; {
    <b>let</b> maybe_order = market.get_order_book_mut().<a href="order_operations.md#0x7_order_operations_try_cancel_order">try_cancel_order</a>(<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, order_id);
    <b>if</b> (maybe_order.is_some()) {
        <b>let</b> order = maybe_order.destroy_some();
        <a href="order_operations.md#0x7_order_operations_cancel_single_order_helper">cancel_single_order_helper</a>(market, order, emit_event, callbacks);
        <a href="../../accudo-framework/../accudo-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(order)
    } <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="order_operations.md#0x7_order_operations_decrease_order_size">decrease_order_size</a>&lt;M: store + <b>copy</b> + drop, R: store + <b>copy</b> + drop&gt;(
    ...
    <a href="order_book.md#0x7_order_book">order_book</a>.<a href="order_operations.md#0x7_order_operations_decrease_order_size">decrease_order_size</a>(<a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, order_id, size_delta);
    ...
    market.emit_event_for_order(
        ...
        is_bid,
        <b>false</b>,
        accudo_experimental::market_types::order_status_size_reduced(),
...
<pre><code><b>fun</b> <a href="order_operations.md#0x7_order_operations_cancel_single_order_helper">cancel_single_order_helper</a>&lt;M: store + <b>copy</b> + drop, R: store + <b>copy</b> + drop&gt;(
    ...
    cleanup_order_internal(
        <a href="../../accudo-framework/doc/account.md#0x1_account">account</a>, order_id, client_order_id, single_order_type(), is_bid, time_in_force, remaining_size, price, metadata, callbacks, <b>false</b>
    );
    <b>if</b> (emit_event) {
        market.emit_event_for_order(
            order_id,
            ...
            is_bid,
            <b>false</b>,
            accudo_experimental::market_types::order_status_cancelled(),
