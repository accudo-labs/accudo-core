/// `PropertyMap` provides generic metadata support for `AccudoToken`. It is a specialization of
...
module accudo_token_objects::property_map {
    use std::bcs;
    use std::error;
    ...
    use accudo_framework::object::{Self, ConstructorRef, Object, ExtendRef, ObjectCore};
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = accudo_std::from_bcs)]
