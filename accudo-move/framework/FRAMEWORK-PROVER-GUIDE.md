This guide gives some hints to troubleshoot issues when using the prover for specifying the Accudo frameworks.

## Installation

Please refer to the [doc](https://accudo.dev/build/cli/setup-cli/install-move-prover/).
...
you could use the command `cargo test --release -p accudo-framework -- --skip prover`.


## Specification guide

Please refer to the [Move Prover Book](https://accudo.dev/guides/prover-guides/move-prover)
