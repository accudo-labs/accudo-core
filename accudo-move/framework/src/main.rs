...
use accudo_framework::{ReleaseOptions, ReleaseTarget};
use clap::Parser;

#[derive(Parser)]
#[clap(name = "accudo-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an Accudo framework release for the specified target.
