...
impl ReleaseTarget {
    ...
    pub fn packages(self) -> Vec<(&'static str, Option<&'static str>, bool)> {
        let result = vec![
            ...
            ("accudo-stdlib", None, false),
            (
                "accudo-framework",
                Some("cached-packages/src/accudo_framework_sdk_builder.rs"),
                false,
            ),
            (
                "accudo-token",
                Some("cached-packages/src/accudo_token_sdk_builder.rs"),
                false,
            ),
            (
                "accudo-token-objects",
                Some("cached-packages/src/accudo_token_objects_sdk_builder.rs"),
                false,
            ),
            ("accudo-experimental", None, true),
        ];
...
static NAMED_ADDRESSES: Lazy<BTreeMap<String, NumericalAddress>> = Lazy::new(|| {
    ...
    result.insert("accudo_std".to_owned(), one);
    result.insert("accudo_framework".to_owned(), one);
    result.insert("accudo_token".to_owned(), three);
    result.insert("accudo_token_objects".to_owned(), four);
    result.insert("accudo_experimental".to_owned(), seven);
    result.insert("accudo_fungible_asset".to_owned(), ten);
