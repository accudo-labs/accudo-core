---
id: Accudo-vm-benchmarks
title: Accudo VM Benchmarks
---

## Accudo VM Benchmarks

The Accudo VM Benchmark allows anyone to specify a set of Move modules and benchmark 
the running time of transactions in the AccudoVM measured in milliseconds. The Accudo
...
```
cd accudo-vm-benchmarks/samples
mkdir proj-name
cd proj-name
cargo run -p accudo -- move init --name proj-name
```
