...
//! This module defines the gas parameters for Accudo Framework & Stdlib.
...
crate::gas_schedule::macros::define_gas_parameters!(
    AccudoFrameworkGasParameters,
    "accudo_framework",
    NativeGasParameters => .accudo_framework,
    [
        ...
        // These are dummy value, they copied from storage gas in accudo-core/accudo-vm/src/accudo_vm_impl.rs
