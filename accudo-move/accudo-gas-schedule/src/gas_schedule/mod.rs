...
pub use accudo_framework::AccudoFrameworkGasParameters;
...
pub mod gas_params {
    ...
    pub mod natives {
        use super::*;
        pub use accudo_framework::gas_params as accudo_framework;
        pub use move_stdlib::gas_params as move_stdlib;
        pub use table::gas_params as table;
    }
}

/// Gas parameters for everything that is needed to run the Accudo blockchain, including
/// instructions, transactions and native functions from various packages.
#[derive(Debug, Clone)]
pub struct AccudoGasParameters {
    pub vm: VMGasParameters,
    pub natives: NativeGasParameters,
}

impl FromOnChainGasSchedule for AccudoGasParameters {
...
impl ToOnChainGasSchedule for AccudoGasParameters {
...
impl InitialGasSchedule for AccudoGasParameters {
    fn initial() -> Self {
        Self {
...
pub struct NativeGasParameters {
    ...
    pub accudo_framework: AccudoFrameworkGasParameters,
}
...
impl FromOnChainGasSchedule for NativeGasParameters {
    fn from_on_chain_gas_schedule(
        ...
        Ok(Self {
            ...
            accudo_framework: FromOnChainGasSchedule::from_on_chain_gas_schedule(
                gas_schedule,
                feature_version,
            )?,
        })
...
impl NativeGasParameters {
    pub fn zeros() -> Self {
        Self {
            ...
            accudo_framework: AccudoFrameworkGasParameters::zeros(),
        }
    }
}
...
impl InitialGasSchedule for NativeGasParameters {
    fn initial() -> Self {
        Self {
            ...
            accudo_framework: InitialGasSchedule::initial(),
        }
    }
}
