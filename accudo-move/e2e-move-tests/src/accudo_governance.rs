...
pub fn create_proposal_v2(
    ...
    harness.run_transaction_payload(
        account,
        accudo_stdlib::accudo_governance_create_proposal_v2(
            stake_pool,
            execution_hash,
            metadata_location,
            metadata_hash,
...
pub fn partial_vote(
    ...
    harness.run_transaction_payload(
        account,
        accudo_stdlib::accudo_governance_partial_vote(
            stake_pool,
            proposal_id,
            voting_power,
            should_pass,
...
pub fn get_remaining_voting_power(
    ...
    let fun = MemberId::from_str("0x1::accudo_governance::get_remaining_voting_power").unwrap();
    let res = harness
