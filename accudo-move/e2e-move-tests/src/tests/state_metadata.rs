...
use accudo_sdk::types::get_apt_primary_store_address;
use accudo_types::{
...
fn test_metadata_tracking() {
    ...
    harness.run_transaction_payload(
        &account1,
        accudo_cached_packages::accudo_stdlib::accudo_account_transfer(address2, 100),
    );
    ...
    harness.run_transaction_payload(
        &account1,
        accudo_cached_packages::accudo_stdlib::accudo_account_transfer(address3, 100),
    );
