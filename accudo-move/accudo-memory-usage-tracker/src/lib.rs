...
use accudo_gas_meter::{AccudoGasMeter, CacheValueSizes};
use accudo_types::{
...
where
    G: AccudoGasMeter + CacheValueSizes,
{
    ...
    G: AccudoGasMeter + CacheValueSizes,
{
    ...
    fn charge_native_function_before_execution(
        ...
        // TODO(Gas): https://github.com/accudo-labs/accudo-core/issues/5485
...
impl<G> AccudoGasMeter for MemoryTrackedGasMeter<G>
where
    G: AccudoGasMeter + CacheValueSizes,
{
