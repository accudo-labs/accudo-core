...
use accudo_validator_interface::{AccudoValidatorInterface, DebuggerStateView};
use std::{
    collections::HashMap,
    ops::DerefMut,
    sync::{Arc, Mutex},
...
impl DataStateView {
    pub fn new(
        db: Arc<dyn AccudoValidatorInterface + Send>,
        version: Version,
    ...
    pub fn debugger(&self) -> &Arc<dyn AccudoValidatorInterface + Send> {
        &self.debugger
    }
}
