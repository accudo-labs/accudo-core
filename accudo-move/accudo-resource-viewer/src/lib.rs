...
use accudo_types::state_store::StateView;
use accudo_vm::data_cache::get_resource_group_member_from_metadata;
...
pub struct AccudoValueAnnotator<'a, S>(MoveValueAnnotator<ModuleView<'a, S>>);

impl<'a, S: StateView> AccudoValueAnnotator<'a, S> {
