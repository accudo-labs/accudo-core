# Accudo VM Profiling Scripts

This is a collection of scripts to profile the Move VM and the Accudo VM using Valgrind,
...
## Running the Scripts
To run the scripts, simply invoke the main binary via `cargo run -p accudo-vm-profiling`.
