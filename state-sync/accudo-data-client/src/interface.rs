...
use accudo_storage_service_types::{responses::TransactionOrOutputListWithProofV2, Epoch};
use accudo_types::{
...
/// The API offered by the Accudo Data Client.
#[async_trait]
pub trait AccudoDataClientInterface {
...
/// A response error that users of the Accudo Data Client can use to notify
