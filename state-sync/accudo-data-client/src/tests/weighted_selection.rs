...
use accudo_config::{
    config::{AccudoDataClientConfig, AccudoDataMultiFetchConfig, AccudoLatencyFilteringConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use accudo_storage_service_types::requests::{DataRequest, StorageServiceRequest};
use accudo_time_service::TimeServiceTrait;
use maplit::hashset;
...
async fn request_latency_filtering() {
    ...
    let data_client_config = AccudoDataClientConfig {
        ...
        latency_filtering_config: AccudoLatencyFilteringConfig {
