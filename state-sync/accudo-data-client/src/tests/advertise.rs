...
use accudo_config::{config::AccudoDataClientConfig, network_id::PeerNetworkId};
...
use accudo_types::transaction::{TransactionListWithProofV2, Version};
...
async fn request_works_only_when_data_available() {
    ...
    for peer_priority in PeerPriority::get_all_ordered_priorities() {
        ...
        // Create the accudo data client config
