...
/// An error returned by the Accudo Data Client for failed API calls.
...
impl From<accudo_storage_service_client::Error> for Error {
    fn from(error: accudo_storage_service_client::Error) -> Self {
        Self::UnexpectedErrorEncountered(error.to_string())
    }
}

impl From<accudo_storage_service_types::responses::Error> for Error {
    fn from(error: accudo_storage_service_types::responses::Error) -> Self {
