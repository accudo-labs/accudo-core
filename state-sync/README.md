...
id: state sync
title: State Sync
custom_edit_url: https://github.com/accudo-labs/accudo-core/edit/main/state-sync/README.md
---

# State Synchronization (State Sync)

State sync is a component that runs within each Accudo node and is responsible
...
To read more about state sync and node configurations, see the [state sync developer documentation](https://accudo.dev/guides/state-sync/).
...
this.
3. **Accudo Data Client**: The data client is responsible for handling data
...
- **Driver:** [https://github.com/accudo-labs/accudo-core/tree/main/state-sync/state-sync-driver](https://github.com/accudo-labs/accudo-core/tree/main/state-sync/state-sync-driver)
- **Data Streaming Service:** [https://github.com/accudo-labs/accudo-core/tree/main/state-sync/data-streaming-service](https://github.com/accudo-labs/accudo-core/tree/main/state-sync/data-streaming-service)
- **Accudo Data Client**: [https://github.com/accudo-labs/accudo-core/tree/main/state-sync/accudo-data-client](https://github.com/accudo-labs/accudo-core/tree/main/state-sync/accudo-data-client)
- **Storage Service:** [https://github.com/accudo-labs/accudo-core/tree/main/state-sync/storage-service](https://github.com/accudo-labs/accudo-core/tree/main/state-sync/storage-service)

In addition, there is also a directory containing the code for
**inter-component** communication: [https://github.com/accudo-labs/accudo-core/tree/main/state-sync/inter-component](https://github.com/accudo-labs/accudo-core/tree/main/state-sync/inter-component).
