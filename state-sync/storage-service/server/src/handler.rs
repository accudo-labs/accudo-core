...
use accudo_config::{config::StorageServiceConfig, network_id::PeerNetworkId};
use accudo_logger::{debug, sample, sample::SampleRate, trace, warn};
use accudo_network::protocols::wire::handshake::v1::ProtocolId;
...
impl<T: StorageReaderInterface> Handler<T> {
    ...
    ) -> accudo_storage_service_types::Result<StorageServiceResponse> {
    ...
    pub(crate) fn send_response(
        &self,
        request: StorageServiceRequest,
        response: accudo_storage_service_types::Result<StorageServiceResponse>,
        response_sender: ResponseSender,
    ) {
    ...
    fn process_cachable_request(
        ...
        peer_network_id: &PeerNetworkId,
        request: &StorageServiceRequest,
    ) -> accudo_storage_service_types::Result<StorageServiceResponse, Error> {
    ...
    ) -> accudo_storage_service_types::Result<DataResponse, Error> {
...
fn log_storage_response(
    ...
    storage_response: &accudo_storage_service_types::Result<
