...
use accudo_logger::{debug, warn};
use accudo_storage_interface::{AccudoDbError, DbReader, Result as StorageResult};
...
/// The interface into local storage (e.g., the Accudo DB) used by the storage
...
pub trait StorageReaderInterface: Clone + Send + 'static {
    ...
    fn get_data_summary(&self) -> accudo_storage_service_types::Result<DataSummary, Error>;
    ...
    ) -> accudo_storage_service_types::Result<EpochChangeProof, Error>;
    ...
    fn get_state_value_chunk_with_proof(
        ...
        start_index: u64,
        end_index: u64,
    ) -> accudo_storage_service_types::Result<StateValueChunkWithProof, Error>;
}
...
impl StorageReader {
    ...
    ) -> accudo_storage_service_types::Result<Option<CompleteDataRange<Version>>, Error> {
    ...
    ($(
        ...
        $(
            ...
            fn $name(&self, $($arg: $ty),*) -> $return_type {
                ...
                result.map_err(|e| AccudoDbError::Other(e.to_string()))
            }
        )+
    };
}
...
/// `end == u64::MAX`.
fn inclusive_range_len(start: u64, end: u64) -> accudo_storage_service_types::Result<u64, Error> {
    // len = end - start + 1
...
) -> accudo_storage_service_types::Result<(bool, u64), Error> {
