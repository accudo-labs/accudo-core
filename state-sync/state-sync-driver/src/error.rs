...
impl From<accudo_data_streaming_service::error::Error> for Error {
    fn from(error: accudo_data_streaming_service::error::Error) -> Self {
        Error::UnexpectedError(error.to_string())
    }
}

impl From<accudo_event_notifications::Error> for Error {
    fn from(error: accudo_event_notifications::Error) -> Self {
