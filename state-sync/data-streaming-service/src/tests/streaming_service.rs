...
use crate::{
    ...
    tests::utils::{
        create_ledger_info, get_data_notification, initialize_logger, MockAccudoDataClient,
...
pub fn create_streaming_client_and_server(
    ...
    StreamingServiceClient,
    DataStreamingService<MockAccudoDataClient>,
) {
    initialize_logger();
    ...
    let accudo_data_client_config = AccudoDataClientConfig::default();
    let accudo_data_client = MockAccudoDataClient::new(
