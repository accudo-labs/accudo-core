...
use accudo_data_client::interface::{Response, ResponsePayload};
use accudo_types::{
...
/// A request that has been sent to the Accudo data client.
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl PendingClientResponse {
    ...
    pub fn new_with_response(
        ...
        client_response: Result<Response<ResponsePayload>, accudo_data_client::error::Error>,
    ) -> Self {
        Self {
            client_request,
