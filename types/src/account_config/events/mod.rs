...
pub fn is_accudo_governance_create_proposal_event(event_type: &str) -> bool {
    event_type == "0x1::accudo_governance::CreateProposal"
        || event_type == "0x1::accudo_governance::CreateProposalEvent"
}
