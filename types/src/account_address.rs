...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"accudo_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"accudo_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"accudo_framework::vesting";
...
// See this issue for potential improvements: https://github.com/accudo-labs/accudo-core/issues/3960
...
mod hasher {
    #[derive(serde::Deserialize, accudo_crypto_derive::CryptoHasher)]
