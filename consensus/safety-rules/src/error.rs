...
impl From<accudo_secure_storage::Error> for Error {
    fn from(error: accudo_secure_storage::Error) -> Self {
        match error {
            accudo_secure_storage::Error::PermissionDenied => {
            ...
            accudo_secure_storage::Error::KeyVersionNotFound(_, _)
            | accudo_secure_storage::Error::KeyNotSet(_) => {
