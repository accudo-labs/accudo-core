...
struct BufferManagerHandle {
    ...
    pub commit_tx:
        Option<accudo_channel::Sender<AccountAddress, (AccountAddress, IncomingCommitRequest)>>,
...
impl BufferManagerHandle {
    ...
    pub fn init(
        ...
        commit_tx: accudo_channel::Sender<AccountAddress, (AccountAddress, IncomingCommitRequest)>,
...
impl ExecutionProxyClient {
    ...
    fn spawn_decoupled_execution(
        ...
        let (commit_msg_tx, commit_msg_rx) =
            accudo_channel::new::<AccountAddress, (AccountAddress, IncomingCommitRequest)>(
                QueueStyle::FIFO,
                100,
...
impl TExecutionClient for ExecutionProxyClient {
    async fn start_epoch(
        ...
        let block_executor_onchain_config: accudo_types::block_executor::config::BlockExecutorConfigFromOnchain =
...
impl TExecutionClient for DummyExecutionClient {
    async fn start_epoch(
        ...
        _rand_msg_rx: accudo_channel::Receiver<AccountAddress, IncomingRandGenRequest>,
