...
pub fn start_consensus(
    ...
    let execution_proxy = ExecutionProxy::new(
        Arc::new(BlockExecutor::<AccudoVMBlockExecutor>::new(accudo_db)),
        txn_notifier,
        state_sync_notifier,
    ...
    let (timeout_sender, timeout_receiver) =
        accudo_channels::new(1_024, &counters::PENDING_ROUND_TIMEOUTS);
    let (self_sender, self_receiver) =
        accudo_channels::new_unbounded(&counters::PENDING_SELF_MESSAGES);
