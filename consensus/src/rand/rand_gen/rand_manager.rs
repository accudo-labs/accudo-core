...
use accudo_config::config::ReliableBroadcastConfig;
use accudo_consensus_types::common::{Author, Round};
use accudo_infallible::Mutex;
use accudo_logger::{error, info, spawn_named, trace, warn};
...
impl<S: TShare, D: TAugmentedData> RandManager<S, D> {
    ...
    async fn verification_task(
        epoch_state: Arc<EpochState>,
        mut incoming_rpc_request: accudo_channel::Receiver<Author, IncomingRandGenRequest>,
    ...
    pub async fn start(
        ...
        incoming_rpc_request: accudo_channel::Receiver<Author, IncomingRandGenRequest>,
