...
use accudo_types::{on_chain_config::ValidatorTxnConfig, validator_txn::ValidatorTransaction};
use accudo_validator_transaction_pool::TransactionFilter;
use fail::fail_point;
...
impl MixedPayloadClient {
    ...
    fn extra_test_only_vtxns(&self) -> Vec<ValidatorTransaction> {
        fail_point!("mixed_payload_client::extra_test_only_vtxns", |_| {
            use accudo_types::dkg::{DKGTranscript, DKGTranscriptMetadata};
