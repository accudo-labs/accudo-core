...
pub fn sort_peers_by_subscription_optimality(
    ...
    for (peer_network_id, peer_metadata) in peers_and_metadata {
        ...
        let distance =
            distance.unwrap_or(accudo_peer_monitoring_service_types::MAX_DISTANCE_FROM_VALIDATORS);
...
mod tests {
    ...
    use accudo_config::{config::PeerRole, network_id::NetworkId};
    ...
    use accudo_types::{network_address::NetworkAddress, transaction::Version, PeerId};
    use bytes::Bytes;
