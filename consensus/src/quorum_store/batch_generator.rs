...
use accudo_config::config::QuorumStoreConfig;
...
use accudo_types::{quorum_store::BatchId, transaction::SignedTransaction, PeerId};
...
impl BatchGenerator {
    pub(crate) fn new(
            ...
            .expect("Could not read from db")
        {
            ...
            BatchId::new(accudo_infallible::duration_since_epoch().as_micros() as u64)
        };
    ...
    pub(crate) async fn handle_scheduled_pull(&mut self, max_count: u64) -> Vec<Batch> {
        ...
        let expiry_time = accudo_infallible::duration_since_epoch().as_micros() as u64
    ...
    pub(crate) fn handle_remote_batch(
        ...
        let expiry_time_usecs = accudo_infallible::duration_since_epoch().as_micros() as u64
