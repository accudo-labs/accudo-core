...
use accudo_reliable_broadcast::{RBMessage, RBNetworkSender};
use accudo_types::{
...
pub struct NetworkReceivers {
    ...
    pub consensus_messages: accudo_channel::Receiver<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    pub quorum_store_messages: accudo_channel::Receiver<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    pub rpc_rx: accudo_channel::Receiver<
...
pub struct NetworkSender {
    ...
    time_service: accudo_time_service::TimeService,
}
...
impl NetworkSender {
    pub fn new(
        ...
        NetworkSender {
            ...
            self_sender,
            validators,
            time_service: accudo_time_service::TimeService::real(),
        }
    }
...
pub struct NetworkTask {
    consensus_messages_tx: accudo_channel::Sender<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    quorum_store_messages_tx: accudo_channel::Sender<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    rpc_tx: accudo_channel::Sender<
        (AccountAddress, Discriminant<IncomingRpcRequest>),
        (AccountAddress, IncomingRpcRequest),
    >,
...
impl NetworkTask {
    ...
    pub fn new(
        ...
        self_receiver: accudo_channels::UnboundedReceiver<Event<ConsensusMsg>>,
    ) -> (NetworkTask, NetworkReceivers) {
        let (consensus_messages_tx, consensus_messages) = accudo_channel::new(
            QueueStyle::FIFO,
            10,
            Some(&counters::CONSENSUS_CHANNEL_MSGS),
        );
        let (quorum_store_messages_tx, quorum_store_messages) = accudo_channel::new(
            QueueStyle::FIFO,
        ...
        let (rpc_tx, rpc_rx) =
            accudo_channel::new(QueueStyle::FIFO, 10, Some(&counters::RPC_CHANNEL_MSGS));
                    ...
                    match msg {
                        ...
                        ConsensusMsg::CommitVoteMsg(commit_vote) => {
                            ...
                            if let Err(e) = self.rpc_tx.push(
                                ...
                                warn!(error = ?e, "accudo channel closed");
                            };
                        },
