...
use accudo_infallible::{checked, Mutex};
use accudo_logger::prelude::*;
#[cfg(test)]
use accudo_safety_rules::ConsensusState;
use accudo_safety_rules::TSafetyRules;
...
pub struct RoundManager {
    ...
    buffered_proposal_tx: accudo_channel::Sender<Author, VerifiedEvent>,
    ...
    opt_proposal_loopback_tx: accudo_channels::UnboundedSender<OptBlockData>,
}
...
impl RoundManager {
    ...
    async fn resend_verified_proposal_to_self(
        block_store: Arc<BlockStore>,
        self_sender: accudo_channel::Sender<Author, VerifiedEvent>,
        proposal: Block,
        author: Author,
    ...
    pub async fn start(
        mut self,
        mut event_rx: accudo_channel::Receiver<
            (Author, Discriminant<VerifiedEvent>),
            (Author, VerifiedEvent),
        >,
        mut buffered_proposal_rx: accudo_channel::Receiver<Author, VerifiedEvent>,
        mut opt_proposal_loopback_rx: accudo_channels::UnboundedReceiver<OptBlockData>,
