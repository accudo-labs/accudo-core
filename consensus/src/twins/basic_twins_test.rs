...
use accudo_consensus_types::{block::Block, common::Round};
use accudo_types::on_chain_config::ProposerElectionType::{
...
#[ignore] // TODO: https://github.com/accudo-labs/accudo-core/issues/8767
fn drop_config_test() {
    let runtime = consensus_runtime();
    let mut playground = NetworkPlayground::new(runtime.handle().clone());
    let num_nodes = 4;
...
#[test]
#[ignore] // TODO: https://github.com/accudo-labs/accudo-core/issues/6615
