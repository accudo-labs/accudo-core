...
pub const BCS_VIEW_FUNCTION: &str = "application/x.accudo.view_function+bcs";

pub const BCS_SIGNED_TRANSACTION: &str = "application/x.accudo.signed_transaction+bcs";
