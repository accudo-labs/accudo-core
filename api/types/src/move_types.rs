...
mod tests {
    ...
    fn test_parse_invalid_move_module_id_string() {
        ...
        assert_eq!(
            "Invalid Move module ID: Accudo::Accudo",
            "Accudo::Accudo"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid Move module ID: 0x1::Accudo::Accudo",
            "0x1::Accudo::Accudo"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
    ...
    fn test_parse_invalid_move_entry_function_id_string() {
        ...
        assert_eq!(
            "Invalid entry function ID Accudo::Accudo",
            "Accudo::Accudo"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid entry function ID 0x1::Accudo::Accudo::Accudo",
            "0x1::Accudo::Accudo::Accudo"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
                .to_string()
