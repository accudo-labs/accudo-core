...
//! documentation within `crates/accudo-openapi`.
//!
...
//! <https://github.com/accudo-labs/accudo-core/issues/2319>
...
// https://github.com/accudo-labs/accudo-core/pull/2703
...
use accudo_openapi::{impl_poem_parameter, impl_poem_type};
use indoc::indoc;
use serde_json::json;
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            A hex encoded 32 byte Accudo account address.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::accudo_coin::AccudoCoin".to_string()
        )),
        format = Some("hex"),
        description = Some(indoc! {"
            A hex encoded 32 byte Accudo account address or a struct tag.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::accudo_coin::transfer".to_string()
        )),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    "string",
    (
        example = Some(serde_json::Value::String("0x1::accudo_coin".to_string())),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::coin::CoinStore<0x1::accudo_coin::AccudoCoin>".to_string()
        )),
        ...
        Examples:
          * `0x1::coin::CoinStore<0x1::accudo_coin::AccudoCoin>`
          * `0x1::account::Account`
        ...
        See [doc](https://accudo.dev/concepts/accounts) for more details.
      "})
    )
);
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            ...
            Move `address` type value (32 byte Accudo account address) is serialized into a HexEncodedBytes string.
            For example:
              - `0x1`
            ...
            **Special serialization for Move stdlib types**:
              - [0x1::string::String](https://github.com/accudo-labs/accudo-core/blob/main/third_party/move/move-stdlib/docs/ascii.md)
        ...
        description = Some(indoc! {"
            String representation of an on-chain Move type tag that is exposed in transaction payload.
                ...
                Vector type value examples:
                  - `vector<u8>`
                  - `vector<vector<u64>>`
                  - `vector<0x1::coin::CoinStore<0x1::accudo_coin::AccudoCoin>>`
