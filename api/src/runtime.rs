...
pub fn bootstrap(
    ...
    let runtime = accudo_runtimes::spawn_named_runtime("api".into(), Some(max_runtime_workers));
...
// TODO: https://github.com/accudo-labs/accudo-core/issues/2280
...
> {
    ...
    let contact = ContactObject::new()
        .name("Accudo Labs")
        .url("https://github.com/accudo-labs/accudo-core");

    OpenApiService::new(apis, "Accudo Node API", version.trim())
        .server("/v1")
        .description("The Accudo Node API is a RESTful API for client applications to interact with the Accudo blockchain.")
        .license(license)
        .contact(contact)
        .external_document("https://github.com/accudo-labs/accudo-core")
}
...
mod tests {
    ...
    use accudo_api_test_context::{new_test_context, TestContext};
    use accudo_config::config::{ApiConfig, NodeConfig};
    ...
    // https://github.com/accudo-labs/accudo-core/issues/2977
    #[ignore]
    #[test]
