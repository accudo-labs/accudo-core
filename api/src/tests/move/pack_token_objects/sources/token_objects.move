module addr::token_objects {
    ...
    use accudo_std::string_utils::{to_string};
    ...
    fun create_ambassador_collection(creator: &signer) {
        ...
        collection::set_uri(&mutator_ref, string::utf8(b"Ambassador Collection URI 2"));
    }
    ...
    public entry fun run(creator: &signer, user_addr: address)  acquires AmbassadorToken, AmbassadorLevel {
        // ------------------------------------------
