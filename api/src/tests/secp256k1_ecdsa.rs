...
use accudo_crypto::{ed25519::Ed25519PrivateKey, secp256k1_ecdsa, SigningKey};
...
async fn test_multi_secp256k1_ecdsa(
    ...
    let private_key: secp256k1_ecdsa::PrivateKey = accudo_crypto::Uniform::generate(&mut rng);
    let public_key = accudo_crypto::PrivateKey::public_key(&private_key);
