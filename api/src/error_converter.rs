...
use accudo_api_types::{mime_types::JSON, AccudoError, AccudoErrorCode};
...
/// be a JSON representation of AccudoError. For our own code, this is exactly
...
fn build_error_response(error_string: String) -> Response {
    Json(AccudoError::new_with_error_code(
        error_string,
