...
impl StateApi {
    ...
    ///
    /// The Accudo nodes prune account state history, via a configurable time window.
    ...
    async fn get_account_resource(
        ...
        resource_type
            ...
            .map_err(|err| {
                BasicErrorWith404::bad_request_with_code_no_info(err, AccudoErrorCode::InvalidInput)
            })?;
