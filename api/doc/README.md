...
## Overview
Accudo Node API v1 provides a RESTful interface for interacting with Accudo blockchain nodes. The API enables users to retrieve blockchain information, submit transactions, and query account states.
...
## Getting Started
1. Ensure you have an Accudo node running
...
## Support
- [GitHub Issues](https://github.com/accudo-labs/accudo-core/issues)
- [Discord](https://discord.gg/accudonetwork)
- [Accudo Documentation](https://accudo.dev)
