...
use accudo_db_indexer_schemas::schema::event_sequence_number::EventSequenceNumberSchema;
use accudo_schemadb::DB;
use accudo_storage_interface::{
    state_store::state_view::db_state_view::LatestDbStateCheckpointView, AccudoDbError, DbReader,
    Result,
};
use accudo_types::{
    account_config::{
...
impl EventV2Translator for TokenMutationTranslator {
    fn translate_event_v2_to_v1(
        ...
        let (key, sequence_number) = if let Some(state_value_bytes) = engine
            ...
            return Err(AccudoDbError::from(anyhow::format_err!(
