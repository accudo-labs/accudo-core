...
pub use accudo_types::indexer::indexer_db_reader::Order;
use accudo_types::{
...
pub use accudo_types::block_info::BlockHeight;
use accudo_types::state_store::state_key::prefix::StateKeyPrefix;
pub use errors::AccudoDbError;
pub use ledger_summary::LedgerSummary;

pub type Result<T, E = AccudoDbError> = std::result::Result<T, E>;
...
impl From<accudo_secure_net::Error> for Error {
    fn from(error: accudo_secure_net::Error) -> Self {
        Self::ServiceError {
            error: format!("{}", error),
        }
    }
...
pub trait DbReader: Send + Sync {
    ...
    delegate_read!(
        /// See [AccudoDB::get_epoch_ending_ledger_infos].
        ///
        /// [AccudoDB::get_epoch_ending_ledger_infos]:
        /// ../accudodb/struct.AccudoDB.html#method.get_epoch_ending_ledger_infos
        ...
        /// See [AccudoDB::get_transactions].
        ///
        /// [AccudoDB::get_transactions]: ../accudodb/struct.AccudoDB.html#method.get_transactions
        fn get_transactions(
            &self,
        ...
        /// See [AccudoDB::get_transaction_by_hash].
        ///
        /// [AccudoDB::get_transaction_by_hash]: ../accudodb/struct.AccudoDB.html#method.get_transaction_by_hash
        ...
        /// See [AccudoDB::get_transaction_by_version].
        ///
        /// [AccudoDB::get_transaction_by_version]: ../accudodb/struct.AccudoDB.html#method.get_transaction_by_version
        ...
        /// See [AccudoDB::get_persisted_auxiliary_info_iterator].
        ///
        /// [AccudoDB::get_persisted_auxiliary_info_iterator]: ../accudodb/struct.AccudoDB.html#method.get_persisted_auxiliary_info_iterator
        ...
        /// See [AccudoDB::get_first_txn_version].
        ///
        /// [AccudoDB::get_first_txn_version]: ../accudodb/struct.AccudoDB.html#method.get_first_txn_version
        fn get_first_txn_version(&self) -> Result<Option<Version>>;

        /// See [AccudoDB::get_first_viable_block].
        ///
        /// [AccudoDB::get_first_viable_block]: ../accudodb/struct.AccudoDB.html#method.get_first_viable_block
        fn get_first_viable_block(&self) -> Result<(Version, BlockHeight)>;

        /// See [AccudoDB::get_first_write_set_version].
        ///
        /// [AccudoDB::get_first_write_set_version]: ../accudodb/struct.AccudoDB.html#method.get_first_write_set_version
        fn get_first_write_set_version(&self) -> Result<Option<Version>>;

        /// See [AccudoDB::get_transaction_outputs].
        ///
        /// [AccudoDB::get_transaction_outputs]: ../accudodb/struct.AccudoDB.html#method.get_transaction_outputs
        ...
        /// See [AccudoDB::get_block_timestamp].
        ///
        /// [AccudoDB::get_block_timestamp]:
        /// ../accudodb/struct.AccudoDB.html#method.get_block_timestamp
        fn get_block_timestamp(&self, version: Version) -> Result<u64>;

        /// See `AccudoDB::get_latest_block_events`.
        ...
        /// See [AccudoDB::get_state_value_by_version].
        ///
        /// [AccudoDB::get_state_value_by_version]:
        /// ../accudodb/struct.AccudoDB.html#method.get_state_value_by_version
        ...
        /// See [AccudoDB::get_state_value_with_version_by_version].
        ///
        /// [AccudoDB::get_state_value_with_version_by_version]:
        /// ../accudodb/struct.AccudoDB.html#method.get_state_value_with_version_by_version
        ...
        /// See [AccudoDB::get_account_state_with_proof_by_version].
        ///
        /// [AccudoDB::get_account_state_with_proof_by_version]:
        /// ../accudodb/struct.AccudoDB.html#method.get_account_state_with_proof_by_version
        ///
        /// This is used by accudo core (executor) internally.
    ...
    fn get_latest_ledger_info(&self) -> Result<LedgerInfoWithSignatures> {
        self.get_latest_ledger_info_option().and_then(|opt| {
            opt.ok_or_else(|| AccudoDbError::Other("Latest LedgerInfo not found.".to_string()))
        })
    }
    ...
    fn ensure_synced_version(&self) -> Result<Version> {
        self.get_synced_version()?
            .ok_or_else(|| AccudoDbError::NotFound("Synced version not found.".to_string()))
    }
    ...
    fn ensure_pre_committed_version(&self) -> Result<Version> {
        self.get_pre_committed_version()?
            .ok_or_else(|| AccudoDbError::NotFound("Pre-committed version not found.".to_string()))
    }
}

/// Trait that is implemented by a DB that supports certain public (to client) write APIs
/// expected of an Accudo DB. This adds write APIs to DbReader.
#[allow(unused_variables)]
...
macro_rules! db_anyhow {
    ($($arg:tt)*) => {
        AccudoDbError::Other(format!($($arg)*))
    };
}
...
macro_rules! db_not_found_bail {
    ($($arg:tt)*) => {
        return Err(AccudoDbError::NotFound(format!($($arg)*)))
    };
}
...
macro_rules! db_other_bail {
    ($($arg:tt)*) => {
        return Err(AccudoDbError::Other(format!($($arg)*)))
    };
}
