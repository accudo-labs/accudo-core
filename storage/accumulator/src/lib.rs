    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`accudo_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`accudo_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`accudo_types::proof::AccumulatorRangeProof`] for proof format.
