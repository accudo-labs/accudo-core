...
use accudo_db::{state_restore::StateSnapshotRestoreMode, AccudoDB};
use accudo_executor_test_helpers::integration_test_impl::test_execution_with_storage_impl;
...
fn test_end_to_end_impl(d: TestData) {
    ...
    // Check
    let tgt_db = AccudoDB::new_readonly_for_test(&tgt_db_dir);
    assert_eq!(
