...
//! This module defines representation of Accudo core data structures at physical level via schemas
//! that implement [`accudo_schemadb::schema::Schema`].
//!
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use accudo_schemadb::schema::fuzzing::assert_no_panic_decoding;
