...
//! This crate provides [`AccudoDB`] which represents physical storage of the core Accudo data
//! structures.
//!
//! It relays read/write operations on the physical storage via `schemadb` to the underlying
//! Key-Value storage system, and implements accudo data structures on top of it.

pub use crate::db::AccudoDB;
