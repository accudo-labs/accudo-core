...
use crate::{db_debugger::ShardingConfig, AccudoDB};
use accudo_config::config::StorageConfig;
...
impl Cmd {
    pub fn run(self) -> Result<()> {
        ...
        .expect("Failed to open AccudoDB");

        println!("AccudoDB opened. Kill to exit.");
