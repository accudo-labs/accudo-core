...
use accudo_config::config::{PrunerConfig, RocksdbConfigs, StorageDirPaths};
use accudo_db_indexer::{db_indexer::InternalIndexerDB, Indexer};
use accudo_logger::prelude::*;
use accudo_schemadb::{batch::SchemaBatch, Cache, Env};
use accudo_storage_interface::{db_ensure as ensure, AccudoDbError, Result};
use accudo_types::{ledger_info::LedgerInfoWithSignatures, transaction::Version};
...
/// access to the core Accudo data structures.
pub struct AccudoDB {
...
impl AccudoDB {
    ...
    pub fn create_checkpoint(
        ...
        info!(sharding = sharding, "Creating checkpoint for AccudoDB.");
