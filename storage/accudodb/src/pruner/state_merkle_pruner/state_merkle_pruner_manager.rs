...
use accudo_config::config::StateMerklePrunerConfig;
use accudo_jellyfish_merkle::StaleNodeIndex;
use accudo_schemadb::schema::KeyCodec;
...
/// The `Pruner` is meant to be part of a `AccudoDB` instance and runs in the background to prune old
/// data.
///
