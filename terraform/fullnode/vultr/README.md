Accudo Fullnodes VULTR (https://www.vultr.com/) Deployment
==============================
...
2. Clone the accudo-core repo and go to the terraform vultr folder.

         $ git clone https://github.com/accudo-labs/accudo-core.git

         $ cd accudo-core/terraform/fullnode/vultr
...
11. To verify the correctness of your FullNode, as outlined in the documentation (https://accudo.dev/tutorials/run-a-fullnode/#verify-the-correctness-of-your-fullnode), you will need to set up a port-forwarding mechanism directly to the accudo pod in one ssh terminal and test it in another ssh terminal
