...
variable "chain_id" {
  description = "Accudo chain ID"
  type        = string
  default     = "TESTING"
}

variable "chain_name" {
  description = "Accudo chain name"
  type        = string
  default     = "testnet"
}

variable "image_tag" {
  description = "Docker image tag for Accudo node"
  type        = string
  default     = "devnet"
}
...
variable "helm_release_name_override" {
  description = "If set, overrides the name of the accudo-node helm chart"
  type        = string
  default     = ""
}
