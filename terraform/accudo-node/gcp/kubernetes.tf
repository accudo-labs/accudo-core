provider "kubernetes" {
  host                   = "https://${google_container_cluster.accudo.endpoint}"
  cluster_ca_certificate = base64decode(google_container_cluster.accudo.master_auth[0].cluster_ca_certificate)
