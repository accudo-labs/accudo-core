...
Accudo blockchain node deployment
...
| fullnode.config | object | `{"full_node_networks":[{"network_id":"public"}]}` | Fullnode configuration. See NodeConfig https://github.com/accudo-labs/accudo-core/blob/main/config/src/config/mod.rs |
...
| genesis_blob_upload_url | string | `"https://us-west1-accudo-forge-gcp-0.cloudfunctions.net/signed-url?cluster_name=unknown&era=1"` |  |
...
| validator.config | object | `{}` | Validator configuration. See NodeConfig https://github.com/accudo-labs/accudo-core/blob/main/config/src/config/mod.rs |
...
| validator.image.repo | string | `"accudolabs/validator"` | Image repo to use for validator images |
...
StatefulSets:
* `<RELEASE_NAME>-accudo-node-0-validator` - The validator StatefulSet
* `<RELEASE_NAME>-accudo-node-0-fullnode-e<ERA>` - The fullnode StatefulSet

Deployments:
* `<RELEASE_NAME>-accudo-node-0-validator` - The HAProxy deployment
...
Services:
* `<RELEASE_NAME>-accudo-node-0-validator-lb` - Inbound load balancer service that routes to the validator
* `<RELEASE_NAME>-accudo-node-0-fullnode-lb` - Inbound load balancer service that routes to the fullnode
