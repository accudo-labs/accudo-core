...
*/}}
{{- define "accudo-fullnode.fullname" -}}
...
Common labels
*/}}
{{- define "accudo-fullnode.labels" -}}
helm.sh/chart: {{ include "accudo-fullnode.chart" . }}
{{ include "accudo-fullnode.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "accudo-fullnode.selectorLabels" -}}
app.kubernetes.io/part-of: {{ include "accudo-fullnode.name" . }}
...
*/}}
{{- define "accudo-fullnode.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "accudo-fullnode.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}
{{- end -}}

{{- define "accudo-fullnode.backupEnvironment" -}}
...
{{ include "accudo-fullnode.fullname" . }}
{{- end -}}

{{- define "backup.labels" -}}
{{ include "accudo-fullnode.labels" . }}
{{- end -}}
...
{{ include "accudo-fullnode.serviceAccountName" . }}
{{- end -}}

{{- define "backup.backupService" -}}
{{ include "accudo-fullnode.fullname" . }}:6186
{{- end -}}

{{- define "backup.persistentVolumeClaim" -}}
{{ include "accudo-fullnode.fullname" . }}-e{{ .Values.chain.era }}
{{- end -}}
