...
* A running archival fullnode with `index` enabled. You can check more from [here](https://accudo.dev/en/network/nodes/configure/state-sync#archival-pfns) and [fullnode config](https://github.com/accudo-labs/accudo-core/tree/main/ecosystem/indexer-grpc/indexer-grpc-fullnode).
