...
pub static NUM_CONNECTED_STREAMS: Lazy<IntGaugeVec> = Lazy::new(|| {
    register_int_gauge_vec!(
        "accudo_indexer_grpc_v2_num_connected_streams",
...
pub static CACHE_START_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "accudo_indexer_grpc_v2_live_data_service_cache_start_version",
...
pub static CACHE_END_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "accudo_indexer_grpc_v2_live_data_service_cache_end_version",
...
pub static CACHE_SIZE_BYTES: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "accudo_indexer_grpc_v2_live_data_service_cache_size_bytes",
        "Cache size in bytes."
    )
    .unwrap()
});
...
pub static CACHE_SIZE_LIMIT_BYTES: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "accudo_indexer_grpc_v2_live_data_service_cache_size_limit_bytes",
...
pub static LATENCY_MS: Lazy<IntGauge> = Lazy::new(|| {
    register_int_gauge!(
        "accudo_indexer_grpc_v2_live_data_service_latency_ms",
...
pub static COUNTER: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "accudo_indexer_grpc_v2_data_service_counter",
...
pub static TIMER: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "accudo_indexer_grpc_v2_data_service_timer",
