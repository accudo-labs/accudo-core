...
use accudo_indexer_grpc_utils::{
    ...
    constants::{
        ...
        MESSAGE_SIZE_LIMIT, REQUEST_HEADER_ACCUDO_APPLICATION_NAME, REQUEST_HEADER_ACCUDO_EMAIL,
        REQUEST_HEADER_ACCUDO_IDENTIFIER, REQUEST_HEADER_ACCUDO_IDENTIFIER_TYPE,
    },
...
const RESPONSE_HEADER_ACCUDO_CONNECTION_ID_HEADER: &str = "x-accudo-connection-id";
...
impl RawData for RawDataServerWrapper {
    ...
    async fn get_transactions(
        ...
        response.metadata_mut().insert(
            RESPONSE_HEADER_ACCUDO_CONNECTION_ID_HEADER,
...
fn get_request_metadata(
    ...
    let request_metadata_pairs = vec![
        (
            ...
            REQUEST_HEADER_ACCUDO_IDENTIFIER_TYPE,
        ),
        ("request_identifier", REQUEST_HEADER_ACCUDO_IDENTIFIER),
        ("request_email", REQUEST_HEADER_ACCUDO_EMAIL),
        (
            "request_application_name",
            REQUEST_HEADER_ACCUDO_APPLICATION_NAME,
        ),
