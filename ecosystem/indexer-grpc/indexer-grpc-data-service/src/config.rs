...
pub struct IndexerGrpcDataServiceConfig {
    ...
    ///
    /// https://www.notion.so/accudolabs/Runbook-c006a37259394ac2ba904d6b54d180fa?pvs=4#171c210964ec42a89574fc80154f9e85
    ///
...
impl RunnableConfig for IndexerGrpcDataServiceConfig {
    ...
    async fn run(&self) -> Result<()> {
        ...
        // InMemoryCache.
        let in_memory_cache =
            accudo_indexer_grpc_utils::in_memory_cache::InMemoryCache::new_with_redis_connection(
        ...
        let svc = accudo_protos::indexer::v1::raw_data_server::RawDataServer::new(server)
            .send_compressed(CompressionEncoding::Zstd)
            .accept_compressed(CompressionEncoding::Zstd)
            .accept_compressed(CompressionEncoding::Gzip);
