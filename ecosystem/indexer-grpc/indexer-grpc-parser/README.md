# All processors are migrated to [processor repo](https://github.com/accudo-labs/accudo-indexer-processors)
...
## Tutorial
### Prerequisite
* A running PostgreSQL instance, with a valid database. More tutorial can be found [here](https://github.com/accudo-labs/accudo-core/tree/main/crates/indexer#postgres)
...
### Use a custom parser
* Check our [indexer processors](https://github.com/accudo-labs/accudo-indexer-processors)! 
