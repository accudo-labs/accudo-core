...
/// Example:
/// ```
/// use accudo_transaction_filter::UserTransactionFilterBuilder;
///
...
impl From<accudo_protos::indexer::v1::UserTransactionFilter> for UserTransactionFilter {
    fn from(proto_filter: accudo_protos::indexer::v1::UserTransactionFilter) -> Self {
        Self {
...
impl From<UserTransactionFilter> for accudo_protos::indexer::v1::UserTransactionFilter {
...
/// Example:
/// ```
/// use accudo_transaction_filter::EntryFunctionFilterBuilder;
///
...
impl From<accudo_protos::indexer::v1::EntryFunctionFilter> for EntryFunctionFilter {
    fn from(proto_filter: accudo_protos::indexer::v1::EntryFunctionFilter) -> Self {
        Self {
...
impl From<EntryFunctionFilter> for accudo_protos::indexer::v1::EntryFunctionFilter {
...
/// Example:
/// ```
/// use accudo_transaction_filter::{EntryFunctionFilterBuilder, UserTransactionPayloadFilterBuilder};
///
...
impl From<accudo_protos::indexer::v1::UserTransactionPayloadFilter>
    for UserTransactionPayloadFilter
{
    fn from(proto_filter: accudo_protos::indexer::v1::UserTransactionPayloadFilter) -> Self {
        Self {
...
impl From<UserTransactionPayloadFilter>
    for accudo_protos::indexer::v1::UserTransactionPayloadFilter
{
