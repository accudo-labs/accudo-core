...
/// Example:
/// ```
/// use accudo_transaction_filter::MoveStructTagFilterBuilder;
///
...
impl From<accudo_protos::indexer::v1::MoveStructTagFilter> for MoveStructTagFilter {
    fn from(proto_filter: accudo_protos::indexer::v1::MoveStructTagFilter) -> Self {
        Self {
...
impl From<MoveStructTagFilter> for accudo_protos::indexer::v1::MoveStructTagFilter {
