...
/// Example:
/// ```
/// use accudo_transaction_filter::TransactionRootFilterBuilder;
///
...
impl From<accudo_protos::indexer::v1::TransactionRootFilter> for TransactionRootFilter {
    fn from(proto_filter: accudo_protos::indexer::v1::TransactionRootFilter) -> Self {
        Self {
...
impl From<TransactionRootFilter> for accudo_protos::indexer::v1::TransactionRootFilter {
