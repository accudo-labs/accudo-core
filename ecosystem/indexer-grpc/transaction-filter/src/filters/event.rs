...
/// Example:
/// ```
/// use accudo_transaction_filter::{EventFilterBuilder, MoveStructTagFilterBuilder};
///
...
impl From<accudo_protos::indexer::v1::EventFilter> for EventFilter {
    fn from(proto_filter: accudo_protos::indexer::v1::EventFilter) -> Self {
        Self {
...
impl From<EventFilter> for accudo_protos::indexer::v1::EventFilter {
