...
mod test {
    ...
    fn test_error_prop() {
        ...
        assert_eq!(error.to_string(), "Filter Error: This is a test error!\nTrace Path:\naccudo_transaction_filter::traits::test::InnerStruct:   {\"a\":\"test\"}\ncore::option::Option<accudo_transaction_filter::traits::test::InnerStruct>:   {\"a\":\"test\"}\naccudo_transaction_filter::traits::test::OuterStruct:   {\"inner\":{\"a\":\"test\"}}");
    }
}
