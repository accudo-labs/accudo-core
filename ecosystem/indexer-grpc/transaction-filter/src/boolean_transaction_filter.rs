...
impl From<BooleanTransactionFilter> for accudo_protos::indexer::v1::BooleanTransactionFilter {
    fn from(boolean_transaction_filter: BooleanTransactionFilter) -> Self {
        match boolean_transaction_filter {
            BooleanTransactionFilter::And(logical_and) => {
                accudo_protos::indexer::v1::BooleanTransactionFilter {
                    filter: Some(
                        accudo_protos::indexer::v1::boolean_transaction_filter::Filter::LogicalAnd(
                            logical_and.into(),
                        ),
                    ),
                }
            ...
            BooleanTransactionFilter::Or(logical_or) => {
                accudo_protos::indexer::v1::BooleanTransactionFilter {
                    filter: Some(
                        accudo_protos::indexer::v1::boolean_transaction_filter::Filter::LogicalOr(
                            logical_or.into(),
                        ),
                    ),
                }
            ...
            BooleanTransactionFilter::Not(logical_not) => {
                accudo_protos::indexer::v1::BooleanTransactionFilter {
                    filter: Some(
                        accudo_protos::indexer::v1::boolean_transaction_filter::Filter::LogicalNot(
            ...
            BooleanTransactionFilter::Filter(api_filter) => {
                accudo_protos::indexer::v1::BooleanTransactionFilter {
                    filter: Some(
                        accudo_protos::indexer::v1::boolean_transaction_filter::Filter::ApiFilter(
                            api_filter.into(),
                        ),
                    ),
                }
...
impl BooleanTransactionFilter {
    pub fn new_from_proto(
        proto_filter: accudo_protos::indexer::v1::BooleanTransactionFilter,
    ...
    pub fn into_proto(self) -> accudo_protos::indexer::v1::BooleanTransactionFilter {
        self.into()
    }
    ...
    /// use accudo_transaction_filter::filters::{EventFilterBuilder, MoveStructTagFilterBuilder, UserTransactionFilterBuilder};
    ///
...
impl TryFrom<accudo_protos::indexer::v1::LogicalAndFilters> for LogicalAnd {
    type Error = anyhow::Error;

    fn try_from(proto_filter: accudo_protos::indexer::v1::LogicalAndFilters) -> Result<Self> {
        Ok(Self {
            and: proto_filter
                .filters
                .into_iter()
...
impl From<LogicalAnd> for accudo_protos::indexer::v1::LogicalAndFilters {
    fn from(logical_and: LogicalAnd) -> Self {
        accudo_protos::indexer::v1::LogicalAndFilters {
...
impl TryFrom<accudo_protos::indexer::v1::LogicalOrFilters> for LogicalOr {
    type Error = anyhow::Error;

    fn try_from(proto_filter: accudo_protos::indexer::v1::LogicalOrFilters) -> Result<Self> {
        Ok(Self {
            or: proto_filter
                .filters
                .into_iter()
...
impl From<LogicalOr> for accudo_protos::indexer::v1::LogicalOrFilters {
    fn from(logical_or: LogicalOr) -> Self {
        accudo_protos::indexer::v1::LogicalOrFilters {
...
impl TryFrom<Box<accudo_protos::indexer::v1::BooleanTransactionFilter>> for LogicalNot {
    type Error = anyhow::Error;

    fn try_from(
        proto_filter: Box<accudo_protos::indexer::v1::BooleanTransactionFilter>,
    ) -> Result<Self> {
        Ok(Self {
...
impl TryFrom<accudo_protos::indexer::v1::ApiFilter> for APIFilter {
    type Error = anyhow::Error;

    fn try_from(proto_filter: accudo_protos::indexer::v1::ApiFilter) -> Result<Self> {
        Ok(
            match proto_filter
                .filter
                .ok_or(anyhow!("Oneof is not set in ApiFilter."))?
            {
                accudo_protos::indexer::v1::api_filter::Filter::TransactionRootFilter(
                    transaction_root_filter,
                ) => Into::<TransactionRootFilter>::into(transaction_root_filter).into(),
                accudo_protos::indexer::v1::api_filter::Filter::UserTransactionFilter(
                    user_transaction_filter,
                ) => Into::<UserTransactionFilter>::into(user_transaction_filter).into(),
                accudo_protos::indexer::v1::api_filter::Filter::EventFilter(event_filter) => {
...
impl From<APIFilter> for accudo_protos::indexer::v1::ApiFilter {
    fn from(api_filter: APIFilter) -> Self {
        match api_filter {
            APIFilter::TransactionRootFilter(transaction_root_filter) => {
                accudo_protos::indexer::v1::ApiFilter {
                    filter: Some(
                        accudo_protos::indexer::v1::api_filter::Filter::TransactionRootFilter(
            ...
            APIFilter::EventFilter(event_filter) => accudo_protos::indexer::v1::ApiFilter {
                filter: Some(accudo_protos::indexer::v1::api_filter::Filter::EventFilter(
                    accudo_protos::indexer::v1::EventFilter {
...
mod test {
    ...
    // Disabled for now while we investigate an issue with lz4 in accudo-core:
    // https://accudo-org.slack.com/archives/C04PF1X2UKY/p1718995777239809?thread_ts=1718969817.705389&cid=C04PF1X2UKY
    /*
    #[test]
    pub fn test_query_parsing() {
        let trf = TransactionRootFilter {
            success: Some(true),
            txn_type: Some(accudo_protos::transaction::v1::transaction::TransactionType::User),
        };
    ...
    */
    ...
    fn test_into_proto() {
        ...
        let expected_proto = accudo_protos::indexer::v1::BooleanTransactionFilter {
            filter: Some(
                accudo_protos::indexer::v1::boolean_transaction_filter::Filter::LogicalAnd(
                    accudo_protos::indexer::v1::LogicalAndFilters {
                        filters: vec![
                                                    ...
                                                    filter: Some(
                                                        accudo_protos::indexer::v1::boolean_transaction_filter::Filter::ApiFilter(
                                                            accudo_protos::indexer::v1::ApiFilter {
                                                                filter: Some(
                                                                    accudo_protos::indexer::v1::api_filter::Filter::TransactionRootFilter(
                                                                        accudo_protos::indexer::v1::TransactionRootFilter {
                                                                            success: Some(true),
                                                    ...
                                                    filter: Some(
                                                        accudo_protos::indexer::v1::boolean_transaction_filter::Filter::ApiFilter(
                                                            accudo_protos::indexer::v1::ApiFilter {
                                                                filter: Some(
                                                                    accudo_protos::indexer::v1::api_filter::Filter::UserTransactionFilter(
                                                                        accudo_protos::indexer::v1::UserTransactionFilter {
                                                                            sender: Some(
                                                                                "0x0011".to_string()
                                                                            ),
                                                                            payload_filter: None,
                            ...
                            accudo_protos::indexer::v1::BooleanTransactionFilter {
                                filter: Some(
                                    accudo_protos::indexer::v1::boolean_transaction_filter::Filter::ApiFilter(
                                        accudo_protos::indexer::v1::ApiFilter {
                                            filter: Some(
                                                accudo_protos::indexer::v1::api_filter::Filter::EventFilter(
                                                    accudo_protos::indexer::v1::EventFilter {
                                                        struct_type: Some(
                                                            accudo_protos::indexer::v1::MoveStructTagFilter {
