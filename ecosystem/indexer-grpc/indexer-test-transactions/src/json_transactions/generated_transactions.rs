...
pub const IMPORTED_MAINNET_TXNS_2819452713_TOKEN_V1_CANCEL_OFFER_MODULE_EVENT: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2819452713_token_v1_cancel_offer_module_event.json"));

pub const IMPORTED_MAINNET_TXNS_590098441_USER_TXN_SINGLE_SENDER_ED25519: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/590098441_user_txn_single_sender_ed25519.json"));

pub const IMPORTED_MAINNET_TXNS_145959468_ACCOUNT_TRANSACTION: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/145959468_account_transaction.json"
));

pub const IMPORTED_MAINNET_TXNS_2175935_USER_TXN_MULTI_ED25519: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/2175935_user_txn_multi_ed25519.json"
));

pub const IMPORTED_MAINNET_TXNS_2308283617_ASSET_TYPE_V1_NULL_2: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/2308283617_asset_type_v1_null_2.json"
));

pub const IMPORTED_MAINNET_TXNS_2200077877_ACCOUNT_RESTORATION_ROTATED_TO_SINGLE_SECP256K1: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2200077877_account_restoration_rotated_to_single_secp256k1.json"));

pub const IMPORTED_MAINNET_TXNS_1831971037_STAKE_DELEGATION_POOL: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub const IMPORTED_MAINNET_TXNS_3020266695_TOKEN_V1_OFFER_MODULE_EVENT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/3020266695_token_v1_offer_module_event.json"
    ));
...
pub const IMPORTED_MAINNET_TXNS_999929475_COIN_AND_FA_TRANSFERS: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/999929475_coin_and_fa_transfers.json"
));

pub const IMPORTED_MAINNET_TXNS_2200077877_ACCOUNT_RESTORATION_SINGLE_SECP256K1_TXN_POST_ROTATION: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2200077877_account_restoration_single_secp256k1_txn_post_rotation.json"));

pub const IMPORTED_MAINNET_TXNS_2662373625_FA_SECONDARY_STORE_BURNT_WITH_DELETION_EVENT: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2662373625_fa_secondary_store_burnt_with_deletion_event.json"));

pub const IMPORTED_MAINNET_TXNS_11648867_TOKEN_V1_BURN_EVENT: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/11648867_token_v1_burn_event.json"
));

pub const IMPORTED_MAINNET_TXNS_1056780409_ANS_CURRENT_ANS_PRIMARY_NAME_V2: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/1056780409_ans_current_ans_primary_name_v2.json"));

pub const IMPORTED_MAINNET_TXNS_2200077591_ACCOUNT_RESTORATION_SINGLE_ED25519: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2200077591_account_restoration_single_ed25519.json"));

pub const IMPORTED_MAINNET_TXNS_2212040150_TRANSACTION_WITHOUT_EVENTS: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
...
pub const IMPORTED_MAINNET_TXNS_464961735_USER_TXN_SINGLE_KEY_ED25519: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/464961735_user_txn_single_key_ed25519.json"
    ));

pub const IMPORTED_MAINNET_TXNS_438536688_ANS_CURRENT_ANS_LOOKUP_V2: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/438536688_ans_current_ans_lookup_v2.json"
    ));

pub const IMPORTED_MAINNET_TXNS_578318306_OBJECTS_WRITE_RESOURCE: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/578318306_objects_write_resource.json"
));

pub const IMPORTED_MAINNET_TXNS_2308282694_ASSET_TYPE_V1_NULL: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub const IMPORTED_MAINNET_TXNS_999930475_TOKEN_V2_CONCURRENT_MINT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/999930475_token_v2_concurrent_mint.json"
    ));

pub const IMPORTED_MAINNET_TXNS_554229017_EVENTS_WITH_NO_EVENT_SIZE_INFO: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/554229017_events_with_no_event_size_info.json"));

pub const IMPORTED_MAINNET_TXNS_84023785_TOKEN_V1_CLAIM_OFFER: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/84023785_token_v1_claim_offer.json"
));
...
pub const IMPORTED_MAINNET_TXNS_124094774_DELEGATED_POOL_BALANCE: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub const IMPORTED_MAINNET_TXNS_602320562_TOKEN_V2_ACCUDO_TOKEN_MINT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/602320562_token_v2_accudo_token_mint.json"
    ));
...
pub const IMPORTED_MAINNET_TXNS_1830706009_STAKER_GOVERNANCE_RECORD: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/1830706009_staker_governance_record.json"
    ));

pub const IMPORTED_MAINNET_TXNS_423176063_ACCOUNT_TRANSACTION_DELETE: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/423176063_account_transaction_delete.json"
    ));

pub const IMPORTED_MAINNET_TXNS_303690531_ANS_LOOKUP_V2: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/303690531_ans_lookup_v2.json"
));

pub const IMPORTED_MAINNET_TXNS_2200077800_ACCOUNT_RESTORATION_ROTATED_TO_MULTI_KEY: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2200077800_account_restoration_rotated_to_multi_key.json"));

pub const IMPORTED_MAINNET_TXNS_2975888978_FA_SECONDARY_STORE_BURNT_OBJECT_STILL_EXISTS: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/2975888978_fa_secondary_store_burnt_object_still_exists.json"));

pub const IMPORTED_MAINNET_TXNS_1803170308_USER_TXN_MULTI_KEY_KEYLESS: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/1803170308_user_txn_multi_key_keyless.json"
    ));

pub const IMPORTED_MAINNET_TXNS_508365567_FA_V1_EVENTS: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/508365567_fa_v1_events.json"
));

pub const IMPORTED_MAINNET_TXNS_1806220919_OBJECT_UNTRANSFERABLE: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/1806220919_object_untransferable.json"
));

pub const IMPORTED_MAINNET_TXNS_578366445_TOKEN_V2_BURN_EVENT_V2: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/578366445_token_v2_burn_event_v2.json"
));

pub const IMPORTED_MAINNET_TXNS_325355235_TOKEN_V2_UNLIMITED_SUPPLY_MINT: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/325355235_token_v2_unlimited_supply_mint.json"));

pub const IMPORTED_MAINNET_TXNS_255894550_STORAGE_REFUND: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/255894550_storage_refund.json"
));

pub const IMPORTED_MAINNET_TXNS_551057865_USER_TXN_SINGLE_SENDER_WEBAUTH: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/551057865_user_txn_single_sender_webauth.json"));
...
pub const IMPORTED_MAINNET_TXNS_1957950162_FA_MIGRATION_V2_STORE_ONLY: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/1957950162_fa_migration_v2_store_only.json"
    ));

pub const IMPORTED_MAINNET_TXNS_976087151_USER_TXN_SINGLE_SENDER_KEYLESS: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/976087151_user_txn_single_sender_keyless.json"));

pub const IMPORTED_MAINNET_TXNS_1737056775_COIN_TRANSFER_BURN_EVENT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/1737056775_coin_transfer_burn_event.json"
    ));

pub const IMPORTED_MAINNET_TXNS_2080538_ANS_LOOKUP_V1: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub const IMPORTED_MAINNET_TXNS_139449359_STAKE_REACTIVATE: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/139449359_stake_reactivate.json"
));

pub const IMPORTED_MAINNET_TXNS_308783012_FA_TRANSFER: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub const IMPORTED_MAINNET_TXNS_1680592683_FA_MIGRATION_COIN_INFO: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/1680592683_fa_migration_coin_info.json"
));
...
pub const IMPORTED_MAINNET_TXNS_97963136_TOKEN_V1_CANCEL_OFFER: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/97963136_token_v1_cancel_offer.json"
));
...
pub const IMPORTED_MAINNET_TXNS_445585423_TOKEN_MINT_AND_BURN_EVENT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/445585423_token_mint_and_burn_event.json"
    ));

pub const IMPORTED_MAINNET_TXNS_967255533_TOKEN_V2_MUTATION_EVENT: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/967255533_token_v2_mutation_event.json"
));

pub const IMPORTED_MAINNET_TXNS_407418623_USER_TXN_SINGLE_KEY_SECP256K1_ECDSA: &[u8] = include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/json_transactions/imported_mainnet_txns/407418623_user_txn_single_key_secp256k1_ecdsa.json"));

pub const IMPORTED_MAINNET_TXNS_537250181_TOKEN_V2_FIXED_SUPPLY_MINT: &[u8] =
    include_bytes!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/src/json_transactions/imported_mainnet_txns/537250181_token_v2_fixed_supply_mint.json"
    ));
...
pub const IMPORTED_MAINNET_TXNS_155112189_DEFAULT_TABLE_ITEMS: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/155112189_default_table_items.json"
));

pub const IMPORTED_MAINNET_TXNS_178179220_TOKEN_V1_MUTATE_EVENT: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/src/json_transactions/imported_mainnet_txns/178179220_token_v1_mutate_event.json"
));
...
pub const ALL_IMPORTED_MAINNET_TXNS: &[&[u8]] = &[
    ...
    IMPORTED_MAINNET_TXNS_602320562_TOKEN_V2_ACCUDO_TOKEN_MINT,
...
pub const IMPORTED_TESTNET_TXNS_6617355090_MULTI_ED_TXN: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
