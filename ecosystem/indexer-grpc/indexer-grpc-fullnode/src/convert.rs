...
pub fn convert_event(event: &Event) -> transaction::Event {
    let event_key: accudo_types::event::EventKey = event.guid.into();
    transaction::Event {
...
fn convert_validator_transaction(
    api_validator_txn: &accudo_api_types::transaction::ValidatorTransaction,
                        ...
                        validator_transaction::ObservedJwkUpdate {
                            quorum_certified_update: Some(
                                validator_transaction::observed_jwk_update::QuorumCertifiedUpdate {
                                    ...
                                    multi_sig: Some(accudo_protos::transaction::v1::validator_transaction::observed_jwk_update::ExportedAggregateSignature {
