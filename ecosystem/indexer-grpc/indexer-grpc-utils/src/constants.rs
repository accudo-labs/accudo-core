...
pub const GRPC_AUTH_TOKEN_HEADER: &str = "x-accudo-data-authorization";
// GRPC request metadata key for the request name. This is used to identify the
// data destination.
pub const GRPC_REQUEST_NAME_HEADER: &str = "x-accudo-request-name";
...
// https://github.com/accudo-labs/api-gateway/blob/0aae1c17fbd0f5e9b50bdb416f62b48d3d1d5e6b/src/common.rs
...
pub const REQUEST_HEADER_ACCUDO_IDENTIFIER_TYPE: &str = "x-accudo-identifier-type";
/// The identifier uniquely identifies the requester. For an application, this is the
/// application ID, a UUID4.
pub const REQUEST_HEADER_ACCUDO_IDENTIFIER: &str = "x-accudo-identifier";
...
pub const REQUEST_HEADER_ACCUDO_EMAIL: &str = "x-accudo-email";
/// The name of the application, e.g. something like "Graffio Testnet".
pub const REQUEST_HEADER_ACCUDO_APPLICATION_NAME: &str = "x-accudo-application-name";

#[derive(Clone, Serialize, Deserialize, Debug)]
pub struct IndexerGrpcRequestMetadata {
    pub processor_name: String,
    /// See `REQUEST_HEADER_ACCUDO_IDENTIFIER_TYPE` for more information.
    pub request_identifier_type: String,
    /// See `REQUEST_HEADER_ACCUDO_IDENTIFIER` for more information.
    pub request_identifier: String,
    /// See `REQUEST_HEADER_ACCUDO_EMAIL` for more information.
    pub request_email: String,
    /// See `REQUEST_HEADER_ACCUDO_APPLICATION_NAME` for more information.
