...
use accudo_metrics_core::{register_gauge_vec, register_int_gauge_vec, GaugeVec, IntGaugeVec};
use accudo_protos::util::timestamp::Timestamp;
...
pub enum IndexerGrpcStep {
    ...
    TableInfoProcessed,
    // [Indexer Indices] Processed transactions from AccudoDB
