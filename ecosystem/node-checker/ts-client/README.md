# Generated TS client for Accudo Node Health Checker
...
## Quickstart
```bash
pnpm add accudo-node-checker-client
```
...
```
cargo run -p accudo -- node run-local-testnet --faucet-port 8081 --force-restart --assume-yes
```

Run a local Node Health Checker:
```
cargo run -p accudo-node-checker -- server run --baseline-node-config-paths ecosystem/node-checker/configuration_examples/local_testnet.yaml --listen-address 0.0.0.0
```
...
[repo]: https://github.com/accudo-labs/accudo-core
[npm-image-version]: https://img.shields.io/npm/v/accudo.svg
[npm-image-downloads]: https://img.shields.io/npm/dm/accudo.svg
[npm-url]: https://npmjs.org/package/accudo-node-checker-client
[discord-image]: https://img.shields.io/discord/945856774056083548?label=Discord&logo=discord&style=flat~~~~
[discord-url]: https://discord.gg/accudonetwork
