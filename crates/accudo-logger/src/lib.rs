...
//! see the [coding guidelines](https://accudo.dev/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use accudo_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::accudo_logger::{
    AccudoData as Logger, AccudoDataBuilder, LoggerFilterUpdater, Writer, CHANNEL_SIZE,
};
pub use accudo_log_derive::Schema;
pub use event::Event;
