...
/* tslint:disable */
/* eslint-disable */
import type { AccudoTapError } from '../models/AccudoTapError';
...
export class FundService {
    ...
    }): CancelablePromise<FundResponse | AccudoTapError> {
    ...
    public isEligible({
        ...
        requestBody: FundRequest,
    }): CancelablePromise<any | AccudoTapError> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/is_eligible',
            body: requestBody,
