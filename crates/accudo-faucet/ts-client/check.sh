...
PUBLISHED_VERSION=`npm show @accudo-labs/accudo-faucet-client version >& /dev/null || echo 0.0.0`
...
echo "Publish required. Current version: $PUBLISHED_VERSION. New version: $NEW_VERSION. Version and changelog look good."
