...
pub fn accudo_cli_style() -> clap::builder::Styles {
    ...
    Styles::styled()
        ...
        // To test: `accudo help` and `accudo account create`
        ...
        // To test: `accudo account create`
        .error(Style::new().fg_color(Some(Ansi(AnsiColor::BrightRed))))
        // Placeholder eg. <ACCOUNT>
        // To test: `accudo account create` or `accudo account create --help`
        ...
        // To test: `accudo account create --account not-a-number`
