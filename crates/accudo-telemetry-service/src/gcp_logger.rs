...
macro_rules! trace {
    ($($arg:tt)+) => {
        $crate::log!(accudo_logger::Level::Trace, $($arg)+)
    };
}
...
macro_rules! debug {
    ($($arg:tt)+) => {
        $crate::log!(accudo_logger::Level::Debug, $($arg)+)
    };
}
...
macro_rules! info {
    ($($arg:tt)+) => {
        $crate::log!(accudo_logger::Level::Info, $($arg)+)
    };
}
...
macro_rules! warn {
    ($($arg:tt)+) => {
        $crate::log!(accudo_logger::Level::Warn, $($arg)+)
    };
}
...
macro_rules! error {
    ($($arg:tt)+) => {
        $crate::log!(accudo_logger::Level::Error, $($arg)+)
    };
}
...
macro_rules! log {
    ...
    ($level:expr, $($args:tt)+) => {{
        if let Some(trace_id) = $crate::gcp_logger::gcp_trace_id() {
            accudo_logger::log!($level, "logging.googleapis.com/trace"=%trace_id, $($args)+)
        } else {
            accudo_logger::log!($level, $($args)+)
        }
    }};
}
