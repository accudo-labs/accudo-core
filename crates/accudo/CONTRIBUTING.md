# Accudo CLI Development Guide

This is a list of design decisions and guidelines for adding commands to the Accudo CLI.
...
#[derive(Parser)]
#[clap(name = "accudo", author, version, propagate_version = true, styles = accudo_cli_common::accudo_cli_style())]
pub enum Tool {
    #[clap(subcommand)]
...
```bash
accudo move compile --save-metadata
```
