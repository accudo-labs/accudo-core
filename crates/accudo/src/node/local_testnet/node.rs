...
pub struct NodeArgs {
    ...
    #[clap(long, value_parser = accudo_node::load_seed)]
...
impl NodeManager {
    ...
    pub fn new_with_config(
        ...
        node_config.indexer_table_info.table_info_service_mode = match run_txn_stream {
            ...
            true => accudo_config::config::TableInfoServiceMode::IndexingOnly,
            false => accudo_config::config::TableInfoServiceMode::Disabled,
        };
