...
/// with all key types used on the Accudo blockchain.
...
///
/// ```bash
/// accudo key extract-public-key --private-key-file ./path-to-key --output-file ./path-to-output --key-type bls12381
/// ```
#[derive(Debug, Parser)]
