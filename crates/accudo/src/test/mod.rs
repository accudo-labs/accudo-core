...
use accudo_rest_client::{
    accudo_api_types::{MoveStructTag, MoveType},
    Transaction,
};
...
module NamedAddress0::store {
    use std::string;
    use accudo_framework::coin::{Self};
...
impl CliTestFramework {
            ...
            entry_function_args: EntryFunctionArguments {
                ...
                type_arg_vec: TypeArgVec {
                    type_args: vec![MoveType::Struct(MoveStructTag::new(
                        ...
                        ident_str!("accudo_coin").into(),
                        ident_str!("AccudoCoin").into(),
                        vec![],
                    ))],
                },
                json_file: None,
    ...
    async fn last_n_transactions_details(&self, count: u16) -> String {
        let result = accudo_rest_client::Client::new(self.endpoint.clone())
    ...
    pub fn add_move_files(&self) {
        ...
        let hello_blockchain_test_contents = include_str!("../../../../accudo-move/move-examples/hello_blockchain/sources/hello_blockchain_test.move");
    ...
    /// Runs the given script contents using the local accudo_framework directory.
    pub async fn run_script(
        ...
        self.run_script_with_framework_package(index, script_contents, FrameworkPackageArgs {
            framework_git_rev: None,
            framework_local_dir: Some(Self::accudo_framework_dir()),
            skip_fetch_latest_git_deps: false,
        })
        .await
    }
    ...
    /// Runs the given script contents using the accudo_framework from accudo-core git repository.
    ...
    pub fn accudo_framework_dir() -> PathBuf {
