...
use accudo_types::event::EventHandle;
use serde::{Deserialize, Serialize};

pub const ACCOUNT_MODULE: &str = "account";
pub const ACCUDO_ACCOUNT_MODULE: &str = "accudo_account";
pub const ACCUDO_COIN_MODULE: &str = "accudo_coin";
...
pub const ACCUDO_COIN_RESOURCE: &str = "AccudoCoin";
