...
use accudo_rest_client::accudo_api_types::U64;
use accudo_types::{
    chain_id::ChainId,
...
/// [`accudo_types::transaction::SignedTransaction`]
///
...
pub struct ConstructionCombineRequest {
    /// Network identifier describing the blockchain and the chain id
    pub network_identifier: NetworkIdentifier,
    /// A hex encoded, BCS encoded, [`accudo_types::transaction::RawTransaction`]
...
pub struct ConstructionCombineResponse {
    /// A hex encoded, BCS encoded, [`accudo_types::transaction::SignedTransaction`]
...
pub struct ConstructionDeriveRequest {
    /// Network identifier describing the blockchain and the chain id
    pub network_identifier: NetworkIdentifier,
    /// Public key to derive an [`accudo_types::account_address::AccountAddress`] from
...
pub struct ConstructionDeriveResponse {
    /// The account identifier of the account if the [`accudo_types::account_address::AccountAddress`] can be derived.
    ///
...
pub struct ConstructionParseRequest {
    /// Network identifier describing the blockchain and the chain id
    pub network_identifier: NetworkIdentifier,
    /// Whether the transaction is a [`accudo_types::transaction::SignedTransaction`]
    /// or a [`accudo_types::transaction::RawTransaction`]
    pub signed: bool,
    /// A hex encoded, BCS encoded [`accudo_types::transaction::SignedTransaction`]
    /// or a [`accudo_types::transaction::RawTransaction`]
...
pub struct ConstructionParseResponse {
    ...
    /// The signers of the transaction, if it was a [`accudo_types::transaction::SignedTransaction`]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ConstructionPayloadsRequest {
    ...
    pub operations: Vec<Operation>,
    /// Required information for building a [`accudo_types::transaction::RawTransaction`]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ConstructionMetadata>,
    /// Public keys of those who will sign the eventual [`accudo_types::transaction::SignedTransaction`]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub public_keys: Option<Vec<PublicKey>>,
}
...
pub struct ConstructionSubmitResponse {
    /// Hash of the submitted [`accudo_types::transaction::SignedTransaction`]
