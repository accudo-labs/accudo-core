...
async fn build_block(
    ...
    block: accudo_rest_client::accudo_api_types::BcsBlock,
    chain_id: ChainId,
...
async fn get_block_by_index(
    ...
    BlockIdentifier,
    accudo_rest_client::accudo_api_types::BcsBlock,
)> {
...
pub struct BlockRetriever {
    page_size: u16,
    rest_client: Arc<accudo_rest_client::Client>,
}

impl BlockRetriever {
    pub fn new(page_size: u16, rest_client: Arc<accudo_rest_client::Client>) -> Self {
        BlockRetriever {
            page_size,
            rest_client,
        }
    ...
    ) -> ApiResult<accudo_rest_client::accudo_api_types::BcsBlock> {
