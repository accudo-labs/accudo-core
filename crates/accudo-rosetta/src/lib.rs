...
pub struct RosettaContext {
    ...
    rest_client: Option<Arc<accudo_rest_client::Client>>,
...
impl RosettaContext {
    ...
    fn rest_client(&self) -> ApiResult<Arc<accudo_rest_client::Client>> {
...
pub fn bootstrap(
    ...
    rest_client: Option<accudo_rest_client::Client>,
    supported_currencies: HashSet<Currency>,
) -> anyhow::Result<tokio::runtime::Runtime> {
    let runtime = accudo_runtimes::spawn_named_runtime("rosetta".into(), None);
