...
use accudo_rest_client::{accudo_api_types::AccudoErrorCode, error::RestError};
    ...
    fn from(err: RestError) -> Self {
        match err {
            RestError::Api(err) => match err.error.error_code {
                ...
                AccudoErrorCode::BlockNotFound => ApiError::BlockNotFound(Some(err.error.message)),
                AccudoErrorCode::StateValueNotFound => {
                    ApiError::StateValueNotFound(Some(err.error.message))
                },
                AccudoErrorCode::VersionPruned => ApiError::VersionPruned(Some(err.error.message)),
                AccudoErrorCode::BlockPruned => ApiError::BlockPruned(Some(err.error.message)),
                AccudoErrorCode::InvalidInput => ApiError::InvalidInput(Some(err.error.message)),
                ...
                AccudoErrorCode::VmError => ApiError::VmError(Some(err.error.message)),
                AccudoErrorCode::RejectedByFilter => {
                    ApiError::RejectedByFilter(Some(err.error.message))
                },
                AccudoErrorCode::HealthCheckFailed => {
                    ApiError::InternalError(Some(err.error.message))
                },
                AccudoErrorCode::MempoolIsFull => ApiError::MempoolIsFull(Some(err.error.message)),
                AccudoErrorCode::WebFrameworkError => {
                    ApiError::InternalError(Some(err.error.message))
                },
                AccudoErrorCode::BcsNotSupported => ApiError::InvalidInput(Some(err.error.message)),
                AccudoErrorCode::InternalError => ApiError::InternalError(Some(err.error.message)),
                AccudoErrorCode::ApiDisabled => ApiError::InternalError(Some(err.error.message)),
            },
