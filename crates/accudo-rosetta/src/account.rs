...
use accudo_logger::{debug, trace, warn};
use accudo_rest_client::{
    accudo_api_types::{AccudoError, AccudoErrorCode, ViewFunction},
    error::{AccudoErrorResponse, RestError},
    Client,
};
use accudo_types::{account_address::AccountAddress, account_config::AccountResource};
use move_core_types::{
    ident_str,
    identifier::IdentStr,
...
async fn get_sequence_number(
        ...
        .await
    {
        ...
        Err(RestError::Api(AccudoErrorResponse {
            error:
                AccudoError {
                    error_code: AccudoErrorCode::AccountNotFound,
                    ..
                },
            ..
        }))
        | Err(RestError::Api(AccudoErrorResponse {
            error:
                AccudoError {
                    error_code: AccudoErrorCode::ResourceNotFound,
                    ..
                },
            ..
        })) => {
