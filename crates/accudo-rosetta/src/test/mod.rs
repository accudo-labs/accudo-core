...
use accudo_rest_client::accudo_api_types::{ResourceGroup, TransactionOnChainData};
use accudo_types::{
    account_config::{
...
fn test_transaction(
    ...
    TransactionOnChainData {
        version,
        transaction: accudo_types::transaction::Transaction::UserTransaction(
            accudo_types::transaction::SignedTransaction::new(
