...
pub(crate) const ENV_ACCUDO_DISABLE_TELEMETRY: &str = "ACCUDO_DISABLE_TELEMETRY";
pub(crate) const ENV_ACCUDO_FORCE_ENABLE_TELEMETRY: &str = "ACCUDO_FORCE_ENABLE_TELEMETRY";
pub(crate) const ENV_ACCUDO_DISABLE_TELEMETRY_PUSH_METRICS: &str =
    "ACCUDO_DISABLE_TELEMETRY_PUSH_METRICS";
pub(crate) const ENV_ACCUDO_DISABLE_TELEMETRY_PUSH_LOGS: &str = "ACCUDO_DISABLE_TELEMETRY_PUSH_LOGS";
pub(crate) const ENV_ACCUDO_DISABLE_TELEMETRY_PUSH_EVENTS: &str =
    "ACCUDO_DISABLE_TELEMETRY_PUSH_EVENTS";
pub(crate) const ENV_ACCUDO_DISABLE_PROMETHEUS_NODE_METRICS: &str =
    "ACCUDO_DISABLE_PROMETHEUS_NODE_METRICS";
pub(crate) const ENV_ACCUDO_DISABLE_LOG_ENV_POLLING: &str = "ACCUDO_DISABLE_LOG_ENV_POLLING";
...
pub(crate) const ACCUDO_GA_MEASUREMENT_ID: &str = "G-ZX4L6WPCFZ";
pub(crate) const ACCUDO_GA_API_SECRET: &str = "ArtslKPTTjeiMi1n-IR39g";
...
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.accudo.org";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.accudo.org";
