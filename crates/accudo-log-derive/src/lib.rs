...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::accudo_logger::Value::from_serde };
    let from_display = quote! { ::accudo_logger::Value::from_display };
    let from_debug = quote! { ::accudo_logger::Value::from_debug };
    let key_new = quote! { ::accudo_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::accudo_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::accudo_logger::Visitor) {
                #(#visits)*
            }
        }
    };
