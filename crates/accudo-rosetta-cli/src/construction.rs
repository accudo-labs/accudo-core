...
use accudo::common::types::{EncodingOptions, PrivateKeyInputOptions, ProfileOptions};
use accudo_logger::info;
use accudo_rosetta::types::{Currency, TransactionIdentifier};
...
pub struct CreateAccountCommand {
    ...
    #[clap(long, value_parser = accudo::common::types::load_account_arg)]
