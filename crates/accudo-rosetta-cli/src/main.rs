...
//! Accudo Rosetta CLI
//!
//! Why have an Accudo version of the Rosetta CLI?
//!
...
//!
//! We want users to use the Accudo CLI over the Rosetta CLI because of the added complexity of a
//! proxy server.  So, we split it out so general users aren't confused.
//!
//! TODO: Make Accudo CLI framework common among multiple CLIs
