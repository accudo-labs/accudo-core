...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestAccudoCrypto)> {
    (
...
pub struct TestAccudoCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestAccudoCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestAccudoCryptoHasher {
    #[inline]
    fn clone(&self) -> TestAccudoCryptoHasher {
        match *self {
            TestAccudoCryptoHasher(ref __self_0_0) => {
                TestAccudoCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            },
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestAccudoCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestAccudoCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestAccudoCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestAccudoCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestAccudoCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestAccudoCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestAccudoCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestAccudoCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestAccudoCrypto {
    type Hasher = TestAccudoCryptoHasher;

    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestAccudoCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestAccudoCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestAccudoCrypto> {
    (String::arbitrary()).prop_map(TestAccudoCrypto).no_shrink()
}
