...
use crate::{
    ...
    test_utils::{TestAccudoCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestAccudoCrypto> = Lazy::new(|| TestAccudoCrypto("Test Message".to_string()));
fn message() -> &'static TestAccudoCrypto {
    &MESSAGE
}
...
fn test_sample_multisig() {
    ...
    println!("let msg = b\"Hello Accudo!\";");
    print!("//let ks = vector[");
    for k in ks {
        print!("{k}, ")
    }
