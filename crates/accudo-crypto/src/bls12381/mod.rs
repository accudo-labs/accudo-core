...
//! ```
//! use std::iter::zip;
//! use accudo_crypto::test_utils::{KeyPair, TestAccudoCrypto};
//! use accudo_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use accudo_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use accudo_crypto::bls12381::ProofOfPossession;
//! use accudo_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/accudo-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestAccudoCrypto("test".to_owned());
...
//! use accudo_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use accudo_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use accudo_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use accudo_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use accudo_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/accudo-crypto/`
...
//! // signature on TestAccudoCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use accudo_crypto::test_utils::KeyPair;
//! use accudo_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use accudo_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use accudo_crypto::bls12381::ProofOfPossession;
//! use accudo_crypto_derive::{CryptoHasher, BCSCryptoHash};
