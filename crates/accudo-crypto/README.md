...
id: crypto
title: Crypto
custom_edit_url: https://github.com/accudo-labs/accudo-core/edit/main/crypto/crypto/README.md
---

The crypto component hosts all the implementations of cryptographic primitives we use in Accudo: hashing, signatures, multisignatures, aggregate signatures, and key derivation/generation.
