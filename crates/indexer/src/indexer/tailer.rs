...
mod test {
    ...
    use accudo_api_test_context::new_test_context;
    use accudo_api_types::{LedgerInfo as APILedgerInfo, Transaction, U64};
    ...
    async fn test_parsing_and_writing() {
        ...
        if let Transaction::BlockMetadataTransaction(ref mut bmt) = block_metadata_transaction {
            bmt.info.epoch = Some(accudo_api_types::U64::from(1));
        }
