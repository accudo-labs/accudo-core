...
pub const DST_PVSS_PUBLIC_PARAMS: &[u8; 32] = b"ACCUDO_DISTRIBUTED_RANDOMNESS_DST";
/// "Nothing up my sleeve" seed to deterministically-derive the public parameters.
pub const SEED_PVSS_PUBLIC_PARAMS: &[u8; 33] = b"ACCUDO_DISTRIBUTED_RANDOMNESS_SEED";
...
impl Default for PublicParameters {
    /// Verifiably creates Accudo-specific public parameters.
    fn default() -> Self {
