...
pub struct StateSyncConfig {
    ...
    pub accudo_data_client: AccudoDataClientConfig,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct AccudoDataPollerConfig {
...
impl Default for AccudoDataPollerConfig {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct AccudoDataMultiFetchConfig {
...
impl Default for AccudoDataMultiFetchConfig {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct AccudoLatencyFilteringConfig {
...
impl Default for AccudoLatencyFilteringConfig {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct AccudoDataClientConfig {
    /// Whether transaction data v2 is enabled
    pub enable_transaction_data_v2: bool,
    /// The accudo data poller config for the data client
    pub data_poller_config: AccudoDataPollerConfig,
    /// The accudo data multi-fetch config for the data client
    pub data_multi_fetch_config: AccudoDataMultiFetchConfig,
    /// Whether or not to ignore peers with low peer scores
    pub ignore_low_score_peers: bool,
    /// The accudo latency filtering config for the data client
    pub latency_filtering_config: AccudoLatencyFilteringConfig,
...
impl Default for AccudoDataClientConfig {
    fn default() -> Self {
        Self {
            enable_transaction_data_v2: true,
            data_poller_config: AccudoDataPollerConfig::default(),
            data_multi_fetch_config: AccudoDataMultiFetchConfig::default(),
            ignore_low_score_peers: true,
            latency_filtering_config: AccudoLatencyFilteringConfig::default(),
