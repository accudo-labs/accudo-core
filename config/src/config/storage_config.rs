...
/// Port selected RocksDB options for tuning underlying rocksdb instance of AccudoDB.
...
pub struct RocksdbConfigs {
    ...
    /// The size of the single block cache shared by all the DB instances in `AccudoDB`.
...
impl Default for StorageConfig {
    fn default() -> StorageConfig {
        StorageConfig {
            ...
            data_dir: PathBuf::from("/opt/accudo/data"),
...
impl ConfigOptimizer for StorageConfig {
    fn optimize(
        ...
        if let Some(chain_id) = chain_id {
            ...
            {
                panic!("Storage sharding (AIP-97) is not enabled in node config. Please follow the guide to migration your node, and set storage.rocksdb_configs.enable_storage_sharding to true explicitly in your node config. https://accudolabs.notion.site/DB-Sharding-Migration-Public-Full-Nodes-1978b846eb7280b29f17ceee7d480730");
            }
        }
