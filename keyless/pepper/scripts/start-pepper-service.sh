...
ON_CHAIN_GROTH16_VK_URL=https://fullnode.devnet.accudo.org/v1/accounts/0x1/resource/0x1::keyless_account::Groth16VerificationKey
ON_CHAIN_KEYLESS_CONFIG_URL=https://fullnode.devnet.accudo.org/v1/accounts/0x1/resource/0x1::keyless_account::Configuration

# Start the pepper service
echo "Starting the pepper service in local development mode, connecting to Accudo devnet for on-chain data!"
cargo run -p accudo-keyless-pepper-service -- \
