...
/// See, for example:
/// https://fullnode.testnet.accudo.org/v1/accounts/0x1/resource/0x1::keyless_account::Groth16VerificationKey
///
/// Example JSON:
/// {
...
impl OnChainGroth16VerificationKey {
    ...
    /// Note: internally, the fields will contain default values.
